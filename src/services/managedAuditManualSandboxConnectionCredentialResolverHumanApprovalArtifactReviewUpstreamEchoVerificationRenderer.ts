  ...
  return renderVerificationReportMarkdown({
    ...
    meta: [
      ...
      [
        ...
        profile.readyForManagedAuditManualSandboxConnectionCredentialResolverHumanApprovalArtifactReviewUpstreamEchoVerification,
      ],
    ...
    sections: [
      { heading: "Source Node v308", lines: renderSourceNodeV308(profile.sourceNodeV308) },
      { heading: "Java v143 Echo", lines: renderJavaReference(profile.upstreamEvidence.javaV143) },
      { heading: "mini-kv v136 Receipt", lines: renderMiniKvReference(profile.upstreamEvidence.miniKvV136) },
      ...
      { heading: "Summary", entries: profile.summary },
      {
        ...
        emptyText: "No human approval artifact review upstream echo verification blockers.",
      },
      {
        heading: "Warnings",
        messages: profile.warnings,
        emptyText: "No human approval artifact review upstream echo verification warnings.",
      },
      {
        heading: "Recommendations",
        messages: profile.recommendations,
        emptyText: "No human approval artifact review upstream echo verification recommendations.",
      },
