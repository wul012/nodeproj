...
const MINI_KV_CURRENT_RELEASES_WITH_V90_RECEIPT = Object.freeze(["v98", "v99"]);
...
function createSnippetMatches(): ReadinessSnippetMatch[] {
  return [
    ...
    snippet("mini-kv-v90-fixture-digest", MINI_KV_V90_RUNTIME_SMOKE, "\"receipt_digest\":\"fnv1a64:35fe7b1c42714d89\""),
  ];
}
...
function createChecks(
  ...
  return {
    ...
    miniKvV90ReceiptAccepted: /^0\.(?:98|99)\.0$/.test(miniKvV90.projectVersion)
      && MINI_KV_CURRENT_RELEASES_WITH_V90_RECEIPT.includes(miniKvV90.currentReleaseVersion)
      && /^c\/(?:98|99)\/$/.test(miniKvV90.currentArtifactPathHint)
