...
const MINI_KV_CURRENT_RELEASES_WITH_V90_RECEIPT = Object.freeze(["v98", "v99", "v100"]);
...
function createSnippetMatches(): ReadinessSnippetMatch[] {
  return [
    ...
    snippet("mini-kv-v90-fixture-digest", MINI_KV_V90_RUNTIME_SMOKE, "\"receipt_digest\":\"fnv1a64:ad3c0d907eab57b3\""),
  ];
}
...
function createChecks(
  ...
  return {
    ...
    miniKvV90ReceiptAccepted: /^0\.(?:98|99|100)\.0$/.test(miniKvV90.projectVersion)
      && MINI_KV_CURRENT_RELEASES_WITH_V90_RECEIPT.includes(miniKvV90.currentReleaseVersion)
      && /^c\/(?:98|99|100)\/$/.test(miniKvV90.currentArtifactPathHint)
