...
import {
  JAVA_V56_RELEASE_BUNDLE,
  MINI_KV_V65_RUNTIME_ARTIFACT_BUNDLE,
  type JavaReleaseBundleManifestReference,
  type MiniKvRuntimeArtifactBundleManifestReference,
} from "../evidence/crossProjectReleaseBundleGateFixtures.js";
