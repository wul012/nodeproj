...
export function renderManagedAuditManualSandboxConnectionCredentialResolverJavaMiniKvCompletedShardReadinessEvidenceIntakeArchiveVerificationMarkdown(
  profile: ManagedAuditManualSandboxConnectionCredentialResolverJavaMiniKvCompletedShardReadinessEvidenceIntakeArchiveVerificationProfile,
): string {
  return renderVerificationReportMarkdown({
    ...
    meta: [
      ...
      ["Ready for Node v380", profile.readyForNodeV380NextCompletedEvidenceOrLiveGate],
    ...
    sections: [
      { heading: "Source Node v378", entries: profile.sourceNodeV378 },
