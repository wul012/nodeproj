...
export function renderControlledReadOnlyShardPreviewCandidateDocumentMaterialSubmissionPrecheckMarkdown(
  precheck: ControlledReadOnlyShardPreviewCandidateDocumentMaterialSubmissionPrecheck,
): string {
  return [
    "# Controlled read-only shard preview candidate document material submission precheck",
    "",
    ...
    "",
    "## Material Submission Checkpoints",
    ...precheck.checkpoints.flatMap((checkpoint) => [
      "",
    ...
    "",
    "## Material Submission Validators",
    ...precheck.validators.flatMap((validator) => [
      "",
