...
export function renderManagedAuditManualSandboxConnectionCredentialResolverJavaMiniKvActiveShardPlanEvidenceIntakeArchiveVerificationMarkdown(
  profile: ManagedAuditManualSandboxConnectionCredentialResolverJavaMiniKvActiveShardPlanEvidenceIntakeArchiveVerificationProfile,
): string {
  return renderVerificationReportMarkdown({
    ...
    meta: [
      ...
      ["Ready for Node v381 next archive verification", profile.readyForNodeV381NextArchiveVerification],
    ...
    sections: [
      { heading: "Source Node v380", entries: profile.sourceNodeV380 },
