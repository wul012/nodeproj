...
export function loadManagedAuditManualSandboxConnectionCredentialResolverSandboxHandleReviewPacketGateDecisionRecordArchiveVerification(
  ...
  const checks = createChecks(input.config, sourceNodeV360, archiveReferences, parsedArchive,
...
function createChecks(
  ...
  return {
    ...
    allChecksPassedInSourceDecisionRecord:
      ...
      && objectBooleanValuesAllTrue(valueAt(archive.json, "checks"), 20),
