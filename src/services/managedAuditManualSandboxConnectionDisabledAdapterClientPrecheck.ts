...
export function renderManagedAuditManualSandboxConnectionDisabledAdapterClientPrecheckMarkdown(
  ...
  return [
    ...
    `- Ready for disabled adapter client precheck: ${profile.readyForManagedAuditManualSandboxConnectionDisabledAdapterClientPrecheck}`,
    `- Ready for sandbox adapter connection: ${profile.readyForManagedAuditSandboxAdapterConnection}`,
    "",
    "## Source Node v251",
    "",
    ...renderEntries(profile.sourceNodeV251),
    "",
    ...
    "",
    ...renderList(
      profile.disabledAdapterClientPrecheck.requiredEnvHandles.map(formatEnvHandle),
      "No env handles.",
    ),
    "",
    "## Opt-In Gate",
    "",
    ...renderEntries(profile.disabledAdapterClientPrecheck.optInGate),
    "",
    "## Failure Taxonomy",
    "",
    ...renderList(
      profile.disabledAdapterClientPrecheck.failureTaxonomy.map(formatFailureClass),
      "No failure classes.",
    ),
    "",
    "## Dry-Run Response Shape",
    "",
    ...renderEntries(profile.disabledAdapterClientPrecheck.dryRunResponseShape),
    "",
    "## Reused No-Go Conditions",
    "",
    ...renderList([...profile.disabledAdapterClientPrecheck.reusedNoGoConditions], "No no-go conditions."),
    "",
    "## Checks",
    "",
    ...
    "## Production Blockers",
    "",
    ...renderMessages(profile.productionBlockers, "No disabled adapter client precheck blockers."),
    "",
    "## Warnings",
    "",
    ...renderMessages(profile.warnings, "No disabled adapter client precheck warnings."),
    "",
    "## Recommendations",
    "",
    ...renderMessages(profile.recommendations, "No disabled adapter client precheck recommendations."),
    "",
    "## Evidence Endpoints",
    "",
