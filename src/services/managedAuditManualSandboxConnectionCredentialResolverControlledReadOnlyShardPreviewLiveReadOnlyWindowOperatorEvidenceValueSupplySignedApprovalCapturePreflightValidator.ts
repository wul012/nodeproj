...
export function createControlledReadOnlyShardPreviewLiveReadOnlyWindowOperatorEvidenceValueSupplySignedApprovalCapturePreflightBlockedReasons(
  ...
  return [
    gates.sourceSignedApprovalTemplateReady ? null : "SOURCE_SIGNED_APPROVAL_TEMPLATE_NOT_READY",
    gates.captureInputCountComplete ? null : "CAPTURE_PREFLIGHT_INPUT_COUNT_INCOMPLETE",
    gates.captureAttestationCountComplete ? null : "CAPTURE_PREFLIGHT_ATTESTATION_COUNT_INCOMPLETE",
    gates.inputVersionsSequential ? null : "CAPTURE_PREFLIGHT_INPUT_VERSIONS_NOT_SEQUENTIAL",
    gates.attestationVersionsSequential ? null : "CAPTURE_PREFLIGHT_ATTESTATION_VERSIONS_NOT_SEQUENTIAL",
    gates.sourceTemplateFieldsReady ? null : "CAPTURE_PREFLIGHT_SOURCE_TEMPLATE_FIELDS_NOT_READY",
    gates.allInputsReady ? null : "CAPTURE_PREFLIGHT_INPUTS_NOT_READY",
    gates.allAttestationsReady ? null : "CAPTURE_PREFLIGHT_ATTESTATIONS_NOT_READY",
    gates.allInputsRequired ? null : "CAPTURE_PREFLIGHT_INPUTS_NOT_REQUIRED",
    gates.allInputPurposesDeclared ? null : "CAPTURE_PREFLIGHT_INPUT_PURPOSES_MISSING",
    gates.allCaptureBlockersDeclared ? null : "CAPTURE_PREFLIGHT_BLOCKERS_MISSING",
    gates.allRequiredTemplateFieldsCovered ? null : "CAPTURE_PREFLIGHT_TEMPLATE_FIELD_COVERAGE_MISSING",
    gates.allAttestationsRejectMissingInputs ? null : "CAPTURE_PREFLIGHT_ATTESTATIONS_DO_NOT_REJECT_MISSING_INPUTS",
    gates.allAttestationsBlockUnsignedCapture ? null : "CAPTURE_PREFLIGHT_UNSIGNED_CAPTURE_NOT_BLOCKED",
    gates.allAttestationsBlockAutoCapture ? null : "CAPTURE_PREFLIGHT_AUTO_CAPTURE_NOT_BLOCKED",
    gates.allAttestationsBlockRuntimePayload ? null : "CAPTURE_PREFLIGHT_RUNTIME_PAYLOAD_NOT_BLOCKED",
    gates.allAttestationsBlockWrites ? null : "CAPTURE_PREFLIGHT_WRITES_NOT_BLOCKED",
    gates.allAttestationsBlockSiblingMutation ? null : "CAPTURE_PREFLIGHT_SIBLING_MUTATION_NOT_BLOCKED",
    gates.sourceTemplateDigestPresent ? null : "CAPTURE_PREFLIGHT_SOURCE_TEMPLATE_DIGEST_MISSING",
    gates.sourceReviewDigestPresent ? null : "CAPTURE_PREFLIGHT_SOURCE_REVIEW_DIGEST_MISSING",
    gates.sourceTemplateStillPreflightOnly ? null : "CAPTURE_PREFLIGHT_SOURCE_TEMPLATE_NOT_PREFLIGHT_ONLY",
    gates.sourceTemplateStillBlocksCapture ? null : "CAPTURE_PREFLIGHT_SOURCE_TEMPLATE_CAPTURE_ENABLED",
    gates.operatorValueSupplyStillDisabled ? null : "CAPTURE_PREFLIGHT_OPERATOR_VALUE_SUPPLY_ENABLED",
    gates.noCaptureValuesProvided ? null : "CAPTURE_PREFLIGHT_VALUES_ALREADY_PROVIDED",
    gates.noRawSignatureMaterial ? null : "CAPTURE_PREFLIGHT_RAW_SIGNATURE_MATERIAL_PRESENT",
    gates.noApprovalGrantEmitted ? null : "CAPTURE_PREFLIGHT_APPROVAL_GRANT_EMITTED",
    gates.noSignedApprovalPresent ? null : "CAPTURE_PREFLIGHT_SIGNED_APPROVAL_PRESENT",
    gates.evidenceImportStillBlocked ? null : "CAPTURE_PREFLIGHT_EVIDENCE_IMPORT_ENABLED",
    gates.runtimePayloadStillBlocked ? null : "CAPTURE_PREFLIGHT_RUNTIME_PAYLOAD_ENABLED",
    gates.liveExecutionStillBlocked ? null : "CAPTURE_PREFLIGHT_LIVE_EXECUTION_ENABLED",
    gates.productionExecutionStillBlocked ? null : "CAPTURE_PREFLIGHT_PRODUCTION_EXECUTION_ENABLED",
    gates.allInputsReadOnly ? null : "CAPTURE_PREFLIGHT_INPUT_NOT_READ_ONLY",
    gates.allAttestationsReadOnly ? null : "CAPTURE_PREFLIGHT_ATTESTATION_NOT_READ_ONLY",
    gates.noSideEffectsAllowed ? null : "CAPTURE_PREFLIGHT_SIDE_EFFECTS_ALLOWED",
