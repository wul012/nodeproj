...
export function renderManagedAuditManualSandboxConnectionCredentialResolverMinimalReadOnlyIntegrationRegularGateArchiveVerificationMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Managed audit manual sandbox connection credential resolver minimal read-only integration regular gate archive verification",
    meta: [
    ...
    sections: [
      { heading: "Source Node v364", entries: profile.sourceNodeV364 },
      { heading: "Archive Verification", entries: profile.archiveVerification },
      { heading: "CI / Operator Friendly Check", entries: profile.ciOperatorFriendlyCheck },
      {
