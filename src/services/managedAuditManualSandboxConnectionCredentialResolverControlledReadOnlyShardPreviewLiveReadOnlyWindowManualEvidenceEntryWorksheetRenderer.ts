...
export function renderControlledReadOnlyShardPreviewLiveReadOnlyWindowManualEvidenceEntryWorksheetMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Controlled read-only shard preview live read-only window manual evidence entry worksheet",
    meta: [
    ...
    sections: [
      ...
      { heading: "Slots", lines: worksheet.slots.flatMap(renderSlot), bodyLeadingBlankLine: false },
      {
