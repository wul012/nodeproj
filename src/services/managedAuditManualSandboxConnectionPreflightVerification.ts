...
const MINI_KV_CURRENT_RELEASES_WITH_V97_GUARD = Object.freeze(["v98", "v99", "v100", "v101"]);
...
function createSnippetMatches(): PreflightVerificationSnippetMatch[] {
  return [
    ...
    snippet("mini-kv-v97-receipt-digest", MINI_KV_RUNTIME_SMOKE, "\"receipt_digest\":\"fnv1a64:f5c9fa97c073ba43\""),
