...
export function renderControlledReadOnlyShardPreviewLiveReadOnlyWindowOperatorEvidenceValueSupplySignedApprovalCapturePreflightMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Controlled read-only shard preview live read-only window operator evidence value supply signed approval capture preflight",
    meta: [
    ...
    sections: [
      ...
      {
        heading: "Inputs",
        lines: trimVerificationTrailingBlankLine(preflight.inputs.flatMap(renderInput)),
        bodyLeadingBlankLine: false,
      },
      {
        heading: "Attestations",
        lines: trimVerificationTrailingBlankLine(preflight.attestations.flatMap(renderAttestation)),
        bodyLeadingBlankLine: false,
      },
      {
