...
export function renderManagedAuditManualSandboxConnectionCredentialResolverJavaMiniKvRuntimeExecutionPacketApprovalGateReviewArchiveVerificationMarkdown(
  profile: ManagedAuditManualSandboxConnectionCredentialResolverJavaMiniKvRuntimeExecutionPacketApprovalGateReviewArchiveVerificationProfile,
): string {
  return renderVerificationReportMarkdown({
    ...
    meta: [
      ...
      ["Ready for Node v400 runtime execution packet approval input intake", profile.readyForNodeV400RuntimeExecutionPacketApprovalInputIntake],
    ...
    sections: [
      { heading: "Source Node v398", entries: profile.sourceNodeV398 },
