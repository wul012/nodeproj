...
export function renderManagedAuditManualSandboxConnectionCredentialResolverSandboxHandleReviewPrerequisiteIntakeArchiveVerificationMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Managed audit manual sandbox connection credential resolver sandbox handle review prerequisite intake archive verification",
    meta: [
      ...
      ["Ready for v356 sandbox handle review contract decision", profile.readyForNodeV356SandboxHandleReviewContractDecision],
    ...
    sections: [
      { heading: "Source Node v354", entries: profile.sourceNodeV354 },
