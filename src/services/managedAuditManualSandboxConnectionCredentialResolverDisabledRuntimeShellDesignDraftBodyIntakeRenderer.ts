  ...
  return [
    ...renderReleaseReportHeader(
      "Managed audit manual sandbox connection credential resolver disabled runtime shell design draft body intake",
      {
        ...
        "Ready for v335 body intake":
          profile.readyForManagedAuditManualSandboxConnectionCredentialResolverDisabledRuntimeShellDesignDraftBodyIntake,
        "Ready for Node v336 body intake archive verification":
          profile.readyForNodeV336DisabledRuntimeShellDesignDraftBodyIntakeArchiveVerification,
    ...
    ...renderReleaseReportEntriesSection("Source Node v334", {
    ...
    ...renderReleaseReportEntriesSection("Body Intake", profile.bodyIntake),
    ...renderReleaseReportLineSection(
    ...
    ...renderReleaseReportEntriesSection("Summary", {
      ...
      "Source Node v334 checks":
        `${profile.summary.sourceNodeV334PassedCheckCount}/${profile.summary.sourceNodeV334CheckCount}`,
