...
import {
  ...
  JAVA_V82_BUILDER,
  JAVA_V82_RUNBOOK,
  JAVA_V82_WALKTHROUGH,
  MINI_KV_CURRENT_ARTIFACT_PATH_HINTS_WITH_SANDBOX_RECEIPT,
  MINI_KV_CURRENT_RELEASES_WITH_SANDBOX_RECEIPT,
  MINI_KV_RUNTIME_SMOKE,
  MINI_KV_SANDBOX_RECEIPT_DIGESTS,
  MINI_KV_V91_RUNBOOK,
  MINI_KV_V91_WALKTHROUGH,
  MINI_KV_V92_WALKTHROUGH,
  MINI_KV_V93_WALKTHROUGH,
  MINI_KV_V95_WALKTHROUGH,
  MINI_KV_VERIFICATION_MANIFEST,
  readMiniKvRuntimeSmokeEvidence,
  type MiniKvRuntimeSmokeEvidence,
} from "../evidence/managedAuditSandboxAdapterDryRunPackageEvidence.js";

export interface ManagedAuditSandboxAdapterDryRunPackageProfile extends SandboxDryRunGuards, LocalDryRunWriteGuard {
...
interface SandboxAdapterDryRunPackagePlan {
  ...
  evidenceSpan: "Node v224 + Java v82 + mini-kv v91/v98";
...
function createPackagePlan(
  ...
  const requiredEvidence = [
    ...
    "mini-kv v91 sandbox adapter non-participation receipt.",
      "mini-kv v92-v95 formatter and shared utility split quality chain, preserved by the current v98 runtime fixture.",
  ...
  const packageSteps = [
    ...
    "Verify Java v82 guard keeps owner approval, schema rehearsal, and credential boundaries explicit.",
      "Verify mini-kv current runtime fixture preserves v91-origin sandbox non-participation evidence through v98 while keeping the v95 digest chain visible.",
...
function createSnippetMatches(): PackageSnippetMatch[] {
  return [
    ...
    snippet("mini-kv-fixture-current-v98", MINI_KV_RUNTIME_SMOKE, "\"release_version\":\"v102\""),
    snippet("mini-kv-fixture-digest", MINI_KV_RUNTIME_SMOKE, "\"receipt_digest\":\"fnv1a64:f0cae7a4ce0674c2\""),
...
function createMiniKvGuardReference(
  ...
  return {
    ...
    v95StringUtilsSharedSplit: ["v95", "v96", "v97", "v98", "v99", "v100", "v101", "v102"].includes(stringField(evidence, "release_version") ?? "")
...
function createChecks(
  ...
  return {
    ...
    miniKvSandboxReceiptAccepted: MINI_KV_CURRENT_RELEASES_WITH_SANDBOX_RECEIPT.includes(miniKvGuard.currentReleaseVersion)
      ...
      && MINI_KV_CURRENT_ARTIFACT_PATH_HINTS_WITH_SANDBOX_RECEIPT.includes(miniKvGuard.currentArtifactPathHint)
...
function collectWarnings(): SandboxAdapterDryRunPackageMessage[] {
  return [
    ...
    {
      code: "MINIKV_CURRENT_FIXTURE_ADVANCED_TO_V98",
      severity: "warning",
      source: "mini-kv-sandbox-guard",
      message: "mini-kv v91 evidence is consumed through the current v98 runtime smoke fixture, which preserves the v90-origin sandbox receipt and keeps the v95 shared string utility split evidence visible.",
    },
  ];
}
