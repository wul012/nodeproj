...
export function renderControlledReadOnlyShardPreviewLiveReadOnlyWindowOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightMarkdown(
  ...
  return [
    "# Controlled read-only shard preview live read-only window operator evidence value supply signed approval capture artifact preflight",
    "",
    ...
    "",
    "## Fragments",
    ...preflight.fragments.flatMap(renderFragment),
    "## Seals",
    ...preflight.seals.flatMap(renderSeal),
    "## Blocked Reasons",
