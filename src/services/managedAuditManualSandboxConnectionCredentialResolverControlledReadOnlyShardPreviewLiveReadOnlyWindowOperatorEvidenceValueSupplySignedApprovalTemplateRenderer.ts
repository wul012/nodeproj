...
export function renderControlledReadOnlyShardPreviewLiveReadOnlyWindowOperatorEvidenceValueSupplySignedApprovalTemplateMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Controlled read-only shard preview live read-only window operator evidence value supply signed approval template",
    meta: [
    ...
    sections: [
      { heading: "Gates", lines: renderEntries(template.gates), bodyLeadingBlankLine: false },
      {
        heading: "Fields",
        lines: trimVerificationTrailingBlankLine(template.fields.flatMap(renderField)),
        bodyLeadingBlankLine: false,
      },
      {
        heading: "Clauses",
        lines: trimVerificationTrailingBlankLine(template.clauses.flatMap(renderClause)),
        bodyLeadingBlankLine: false,
      },
      {
        heading: "Blocked Reasons",
        lines: renderVerificationBlockedReasonLines(template.blockedReasonCodes),
        bodyLeadingBlankLine: false,
      },
    ],
  });
