...
export function renderManagedAuditManualSandboxConnectionCredentialResolverSandboxHandleReviewPacketGateNonSecretIntakeArchiveVerificationMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Managed audit manual sandbox connection credential resolver sandbox handle review packet/gate non-secret intake archive verification",
    meta: [
      ...
      ["Ready for v360 packet/gate decision record", profile.readyForNodeV360SandboxHandleReviewPacketGateDecisionRecord],
    ...
    sections: [
      { heading: "Source Node v358", entries: profile.sourceNodeV358 },
