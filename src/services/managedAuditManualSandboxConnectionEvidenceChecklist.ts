...
export interface ManagedAuditManualSandboxConnectionEvidenceChecklistProfile extends SandboxDryRunGuards {
...
const MINI_KV_CURRENT_RELEASES_WITH_V95_EVIDENCE = Object.freeze(["v98", "v99", "v100", "v101", "v102"]);
...
const MINI_KV_CURRENT_ARTIFACT_PATH_HINTS_WITH_V95_EVIDENCE = Object.freeze([
  "c/98/",
  "c/99/",
  "c/100/",
  "c/101/",
...
function createMiniKvV95Reference(
  ...
  return {
    ...
    readyForNodeV227EvidenceChecklist: reference.evidencePresent
      ...
      && MINI_KV_CURRENT_ARTIFACT_PATH_HINTS_WITH_V95_EVIDENCE.includes(reference.currentArtifactPathHint)
...
function createChecks(
  ...
  return {
    ...
    miniKvV95RuntimeFixtureAccepted: /^0\.(?:98|99|100|101|102)\.0$/.test(miniKvV95.projectVersion)
      && MINI_KV_CURRENT_RELEASES_WITH_V95_EVIDENCE.includes(miniKvV95.releaseVersion)
      && MINI_KV_CURRENT_ARTIFACT_PATH_HINTS_WITH_V95_EVIDENCE.includes(miniKvV95.currentArtifactPathHint)
...
function createSnippetMatches(): ChecklistSnippetMatch[] {
  return [
    ...
    snippet("mini-kv-v95-runtime-version", MINI_KV_RUNTIME_SMOKE, "\"release_version\":\"v102\""),
...
function collectProductionBlockers(
  ...
  addBlocker(blockers, checks.miniKvV95RuntimeFixtureAccepted, "MINIKV_V95_RUNTIME_FIXTURE_NOT_ACCEPTED", "mini-kv-v95-evidence", "mini-kv current runtime smoke fixture must expose v98 evidence while preserving the v95 sandbox connection receipt digest.");
