...
const MINI_KV_CURRENT_RELEASES_WITH_V95_EVIDENCE = Object.freeze(["v98", "v99", "v100", "v101"]);
...
function createMiniKvV95Reference(
  ...
  return {
    ...
    readyForNodeV227EvidenceChecklist: reference.evidencePresent
      ...
      && /^c\/(?:98|99|100|101)\/$/.test(reference.currentArtifactPathHint)
...
function createChecks(
  ...
  return {
    ...
    miniKvV95RuntimeFixtureAccepted: /^0\.(?:98|99|100|101)\.0$/.test(miniKvV95.projectVersion)
      && MINI_KV_CURRENT_RELEASES_WITH_V95_EVIDENCE.includes(miniKvV95.releaseVersion)
      && /^c\/(?:98|99|100|101)\/$/.test(miniKvV95.currentArtifactPathHint)
...
function createSnippetMatches(): ChecklistSnippetMatch[] {
  return [
    ...
    snippet("mini-kv-v95-runtime-version", MINI_KV_RUNTIME_SMOKE, "\"release_version\":\"v101\""),
