...
export function renderManagedAuditManualSandboxConnectionCredentialResolverSandboxHandleReviewPacketGateDecisionRecordArchiveVerificationMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Managed audit manual sandbox connection credential resolver sandbox handle review packet/gate decision record archive verification",
    meta: [
      ...
      ["Ready for v362 prerequisite closure review", profile.readyForNodeV362SandboxHandleReviewPrerequisiteClosureReview],
    ...
    sections: [
      { heading: "Source Node v360", entries: profile.sourceNodeV360 },
