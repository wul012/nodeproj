...
export function renderManagedAuditIdentityApprovalProvenanceDryRunPacketMarkdown(
  ...
  return renderVerificationReportMarkdown({
    ...
    meta: [
      ...
      [
        "Ready for managed audit identity approval provenance dry-run packet",
        profile.readyForManagedAuditIdentityApprovalProvenanceDryRunPacket,
      ],
    ...
    sections: [
      { heading: "Source Binding Contract", entries: profile.sourceBindingContract },
      { heading: "Java v75 Evidence", entries: profile.upstreamEvidence.javaV75 },
      { heading: "mini-kv v84 Evidence", entries: profile.upstreamEvidence.miniKvV84 },
      { heading: "Dry-run Packet", entries: profile.dryRunPacket },
      ...
      { heading: "Summary", entries: profile.summary },
      {
        ...
        emptyText: "No managed audit identity approval provenance dry-run packet blockers.",
      },
      {
        heading: "Warnings",
        messages: profile.warnings,
        emptyText: "No managed audit identity approval provenance dry-run packet warnings.",
      },
      {
        heading: "Recommendations",
        messages: profile.recommendations,
        emptyText: "No managed audit identity approval provenance dry-run packet recommendations.",
      },
