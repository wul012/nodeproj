...
import {
  JAVA_V57_ROLLBACK_HANDOFF,
  MINI_KV_V66_RESTORE_HANDOFF,
  type JavaRollbackApprovalHandoffReference,
  type MiniKvRestoreCompatibilityHandoffReference,
} from "../evidence/rollbackWindowReadinessChecklistFixtures.js";
