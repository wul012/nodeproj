...
export function renderManagedAuditManualSandboxConnectionCredentialResolverHumanApprovalArtifactReviewPacketMarkdown(
  ...
  return renderVerificationReportMarkdown({
    ...
    meta: [
      ...
      [
        "Ready for human approval artifact review packet",
        profile.readyForManagedAuditManualSandboxConnectionCredentialResolverHumanApprovalArtifactReviewPacket,
      ],
    ...
    sections: [
      { heading: "Source Node v307", lines: renderSourceNodeV307(profile.sourceNodeV307) },
      { heading: "Review Packet Contract", lines: renderReviewPacket(profile.reviewPacket) },
      { heading: "Necessity Proof", lines: renderNecessityProof(profile.necessityProof) },
      { heading: "Checks", entries: profile.checks },
      { heading: "Summary", entries: profile.summary },
      {
        heading: "Production Blockers",
        messages: profile.productionBlockers,
        emptyText: "No human approval artifact review packet blockers.",
      },
      {
        heading: "Warnings",
        messages: profile.warnings,
        emptyText: "No human approval artifact review packet warnings.",
      },
      {
        heading: "Recommendations",
        messages: profile.recommendations,
        emptyText: "No human approval artifact review packet recommendations.",
      },
