...
export function renderControlledReadOnlyShardPreviewLiveReadOnlyWindowOperatorEvidenceValueSupplySignedApprovalCaptureArtifactDraftPreflightMarkdown(
  ...
  return [
    "# Controlled read-only shard preview live read-only window operator evidence value supply signed approval capture artifact draft preflight",
    "",
    ...
    "",
    "## Fields",
    ...preflight.fields.flatMap(renderField),
    "## Guards",
