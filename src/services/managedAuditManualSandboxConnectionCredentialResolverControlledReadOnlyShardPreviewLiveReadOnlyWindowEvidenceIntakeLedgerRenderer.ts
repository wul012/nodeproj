...
export function renderControlledReadOnlyShardPreviewLiveReadOnlyWindowEvidenceIntakeLedgerMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Controlled read-only shard preview live read-only window evidence intake ledger",
    meta: [
    ...
    sections: [
      ...
      { heading: "Entries", lines: ledger.entries.flatMap(renderEntry), bodyLeadingBlankLine: false },
      {
