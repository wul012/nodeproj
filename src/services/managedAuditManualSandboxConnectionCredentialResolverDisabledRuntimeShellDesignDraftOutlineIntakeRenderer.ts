...
export function renderManagedAuditManualSandboxConnectionCredentialResolverDisabledRuntimeShellDesignDraftOutlineIntakeMarkdown(
  ...
  return [
    ...
    `- Ready for v333 outline intake: ${profile.readyForManagedAuditManualSandboxConnectionCredentialResolverDisabledRuntimeShellDesignDraftOutlineIntake}`,
    `- Ready for Node v334 archive verification: ${profile.readyForNodeV334DisabledRuntimeShellDesignDraftOutlineArchiveVerification}`,
    ...
    "## Outline Intake",
    "",
    ...renderEntries(profile.outlineIntake),
    "",
    ...
    `- Source Node v332 checks: ${profile.summary.sourceNodeV332PassedCheckCount}/${profile.summary.sourceNodeV332CheckCount}`,
