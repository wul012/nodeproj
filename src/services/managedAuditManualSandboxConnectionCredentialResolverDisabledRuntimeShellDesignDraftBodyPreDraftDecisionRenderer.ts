...
export function renderManagedAuditManualSandboxConnectionCredentialResolverDisabledRuntimeShellDesignDraftBodyPreDraftDecisionMarkdown(
  ...
  return [
    ...
    `- Ready for v339 pre-draft decision: ${profile.readyForManagedAuditManualSandboxConnectionCredentialResolverDisabledRuntimeShellDesignDraftBodyPreDraftDecision}`,
    `- Ready for Node v340 pre-draft decision archive verification: ${profile.readyForNodeV340DisabledRuntimeShellDesignDraftBodyPreDraftDecisionArchiveVerification}`,
    ...
    "## Pre-Draft Decision",
    "",
    ...renderEntries(profile.preDraftDecisionRecord),
    "",
    "## Decision Questions",
    "",
    ...
    `- Source Node v338 checks: ${profile.summary.sourceNodeV338PassedCheckCount}/${profile.summary.sourceNodeV338CheckCount}`,
    ...
    `- Source review questions: ${profile.summary.sourceAnsweredReviewQuestionCount}/${profile.summary.sourceReviewQuestionCount}`,
