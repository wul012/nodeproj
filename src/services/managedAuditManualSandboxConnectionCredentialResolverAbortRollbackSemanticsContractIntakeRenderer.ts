...
export function renderManagedAuditManualSandboxConnectionCredentialResolverAbortRollbackSemanticsContractIntakeMarkdown(
  ...
  return [
    ...
    `- Ready for contract intake: ${profile.readyForManagedAuditManualSandboxConnectionCredentialResolverAbortRollbackSemanticsContractIntake}`,
    ...
    "## Source Node v325",
    "",
    ...renderSourceNodeV325(profile.sourceNodeV325),
    "",
    "## Abort/Rollback Semantics Contract",
    "",
    ...renderContract(profile.abortRollbackSemanticsContract),
    "",
    ...
    "## Production Blockers",
    "",
    ...renderMessages(profile.productionBlockers, "No abort/rollback semantics contract intake blockers."),
    "",
    "## Warnings",
    "",
    ...renderMessages(profile.warnings, "No abort/rollback semantics contract intake warnings."),
    "",
    "## Recommendations",
    "",
    ...renderMessages(profile.recommendations, "No abort/rollback semantics contract intake recommendations."),
    "",
    "## Evidence Endpoints",
    "",
