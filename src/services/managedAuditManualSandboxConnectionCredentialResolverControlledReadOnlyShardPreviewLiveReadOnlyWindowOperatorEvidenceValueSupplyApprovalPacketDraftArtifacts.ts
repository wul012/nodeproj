...
function createApprovalPacketDraftBlockedReasons(
  ...
  return collectBlockedReasons([
    [gates.sourceValueSupplyEnvelopeReady, "SOURCE_VALUE_SUPPLY_ENVELOPE_NOT_READY"],
    [gates.approvalPacketDraftSlotCountComplete, "APPROVAL_PACKET_DRAFT_SLOT_COUNT_INCOMPLETE"],
    [gates.versionsSequential, "APPROVAL_PACKET_DRAFT_VERSIONS_NOT_SEQUENTIAL"],
    [gates.sourceValueSupplyEnvelopeSlotsReady, "APPROVAL_PACKET_SOURCE_ENVELOPE_SLOTS_NOT_READY"],
    [gates.allEvidenceFilesPresent, "APPROVAL_PACKET_DRAFT_EVIDENCE_FILES_MISSING"],
    [gates.allEvidenceSnippetsMatched, "APPROVAL_PACKET_DRAFT_EVIDENCE_SNIPPETS_NOT_MATCHED"],
    [gates.javaV658ValueSupplyEvidenceCovered, "JAVA_V658_VALUE_SUPPLY_EVIDENCE_NOT_COVERED"],
    [gates.miniKvV610ValueSupplyEvidenceCovered, "MINI_KV_V610_VALUE_SUPPLY_EVIDENCE_NOT_COVERED"],
    [gates.nodeV961ValueSupplyEnvelopeCovered, "NODE_V961_VALUE_SUPPLY_ENVELOPE_NOT_COVERED"],
    [gates.allDraftSlotsReadyForReview, "APPROVAL_PACKET_DRAFT_SLOTS_NOT_READY_FOR_REVIEW"],
    [gates.allApprovalFieldsDeclared, "APPROVAL_PACKET_FIELDS_MISSING"],
    [gates.allReviewRecordFieldsDeclared, "APPROVAL_PACKET_REVIEW_FIELDS_MISSING"],
    [gates.allApprovalPoliciesRequireSignedHumanApproval, "APPROVAL_PACKET_POLICY_NOT_SIGNED_HUMAN"],
    [gates.missingValuePolicyFailClosed, "APPROVAL_PACKET_MISSING_VALUE_POLICY_NOT_FAIL_CLOSED"],
    [gates.malformedValuePolicyRejects, "APPROVAL_PACKET_MALFORMED_VALUE_POLICY_NOT_REJECTING"],
    [gates.redactionPolicyRedactsBeforePersist, "APPROVAL_PACKET_REDACTION_POLICY_NOT_SAFE"],
    [gates.provenancePolicyRequiresSourceEvidence, "APPROVAL_PACKET_PROVENANCE_POLICY_NOT_REQUIRED"],
    [gates.noApprovalCaptured, "APPROVAL_PACKET_APPROVAL_ALREADY_CAPTURED"],
    [gates.noApprovalGrantPresent, "APPROVAL_PACKET_GRANT_PRESENT"],
    [gates.noSignedApprovalPresent, "APPROVAL_PACKET_SIGNED_APPROVAL_PRESENT"],
    [gates.operatorIdentityStillPending, "APPROVAL_PACKET_OPERATOR_IDENTITY_PRESENT"],
    [gates.approvalTimestampStillPending, "APPROVAL_PACKET_APPROVAL_TIMESTAMP_PRESENT"],
    [gates.noValuesSupplied, "APPROVAL_PACKET_VALUES_SUPPLIED"],
    [gates.noValuesAccepted, "APPROVAL_PACKET_VALUES_ACCEPTED"],
    [gates.noValuesImported, "APPROVAL_PACKET_VALUES_IMPORTED"],
    [gates.operatorValueSupplyStillDisabled, "APPROVAL_PACKET_OPERATOR_SUPPLY_ENABLED"],
    [gates.operatorValueSubmissionStillDisabled, "APPROVAL_PACKET_OPERATOR_SUBMISSION_ENABLED"],
    [gates.evidenceImportStillBlocked, "APPROVAL_PACKET_EVIDENCE_IMPORT_ENABLED"],
    [gates.manualEntryStillBlocked, "APPROVAL_PACKET_MANUAL_ENTRY_ENABLED"],
    [gates.runtimePayloadStillBlocked, "APPROVAL_PACKET_RUNTIME_PAYLOAD_ENABLED"],
    [gates.liveExecutionStillBlocked, "APPROVAL_PACKET_LIVE_EXECUTION_ENABLED"],
    [gates.productionExecutionStillBlocked, "APPROVAL_PACKET_PRODUCTION_EXECUTION_ENABLED"],
    [gates.noRuntimePayloadImported, "APPROVAL_PACKET_RUNTIME_PAYLOAD_IMPORTED"],
    [gates.noSyntheticEvidenceAccepted, "APPROVAL_PACKET_SYNTHETIC_EVIDENCE_ACCEPTED"],
    [gates.noSecretValues, "APPROVAL_PACKET_SECRET_VALUE_PRESENT"],
    [gates.allSlotsReadOnly, "APPROVAL_PACKET_SLOT_NOT_READ_ONLY"],
    [gates.noWritesAllowed, "APPROVAL_PACKET_WRITES_ALLOWED"],
    [gates.noAutomaticServiceStart, "APPROVAL_PACKET_SERVICE_START_ENABLED"],
    [gates.noSiblingMutation, "APPROVAL_PACKET_MUTATES_SIBLING_STATE"],
    [gates.historicalFallbackReady, "APPROVAL_PACKET_HISTORICAL_FALLBACK_NOT_READY"],
    [gates.noLiveServiceRequired, "APPROVAL_PACKET_LIVE_SERVICE_REQUIRED"],
    [gates.nextStepRequiresSignedApprovalPacket, "APPROVAL_PACKET_NEXT_STEP_NOT_SIGNED_APPROVAL"],
  ]);
}
