...
type CandidateDocumentSubmissionPrecheck = ControlledReadOnlyShardPreviewCandidateDocumentSubmissionPrecheck;

export function renderControlledReadOnlyShardPreviewCandidateDocumentSubmissionPrecheckMarkdown(
  precheck: CandidateDocumentSubmissionPrecheck,
): string {
  return renderVerificationReportMarkdown({
    title: "Controlled read-only shard preview candidate document submission precheck",
    meta: [
    ...
    sections: [
      {
        heading: "Submission Checkpoints",
...
function renderCheckpoint(
  checkpoint: CandidateDocumentSubmissionPrecheck["checkpoints"][number],
): string[] {
  return [
...
function renderValidator(
  validator: CandidateDocumentSubmissionPrecheck["validators"][number],
): string[] {
  return [
