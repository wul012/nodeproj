...
export function renderManagedAuditManualSandboxConnectionCredentialResolverSandboxHandleReviewPrerequisiteIntakeMarkdown(
  ...
  return renderVerificationReportMarkdown({
    title: "Managed audit manual sandbox connection credential resolver sandbox handle review prerequisite intake",
    meta: [
    ...
    sections: [
      { heading: "Source Node v353", entries: profile.sourceNodeV353 },
      { heading: "Necessity Proof", entries: profile.necessityProof },
      { heading: "Prerequisite Inputs", lines: profile.prerequisiteInputs.flatMap(renderPrerequisiteInput) },
