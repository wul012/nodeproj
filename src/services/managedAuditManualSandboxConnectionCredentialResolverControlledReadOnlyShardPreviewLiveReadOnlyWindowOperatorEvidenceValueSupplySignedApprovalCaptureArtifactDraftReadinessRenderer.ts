...
export function renderControlledReadOnlyShardPreviewLiveReadOnlyWindowOperatorEvidenceValueSupplySignedApprovalCaptureArtifactDraftReadinessMarkdown(
  ...
  return [
    "# Controlled read-only shard preview live read-only window operator evidence value supply signed approval capture artifact draft readiness",
    "",
    ...
    "",
    "## Readiness Lanes",
    ...readiness.lanes.flatMap(renderLane),
    "## Readiness Controls",
    ...readiness.controls.flatMap(renderControl),
    "## Blocked Reasons",
