...
export async function registerOpsSummaryRoutes(app: FastifyInstance, deps: OpsSummaryRouteDeps): Promise<void> {
  ...
  app.get<{ Querystring: OpsPromotionArchiveQuery }>("/api/v1/ops/promotion-archive/handoff-certificate/verification", {
    schema: {
      querystring: {
        type: "object",
        properties: {
  ...
  app.get<{ Querystring: OpsPromotionArchiveQuery }>("/api/v1/ops/promotion-archive/handoff-receipt", {
    schema: {
      querystring: {
        type: "object",
        properties: {
  ...
  app.get<{ Querystring: OpsPromotionArchiveQuery }>("/api/v1/ops/promotion-archive/handoff-receipt/verification", {
    schema: {
      querystring: {
        type: "object",
        properties: {
  ...
  app.get<{ Querystring: OpsPromotionArchiveQuery }>("/api/v1/ops/promotion-archive/handoff-closure", {
    schema: {
      querystring: {
        type: "object",
        properties: {
  ...
  app.get<{ Querystring: OpsPromotionArchiveQuery }>("/api/v1/ops/promotion-archive/deployment-execution-record/verification", {
    ...
    return deploymentExecutionRecordVerification;
  });
  ...
  app.get<{ Querystring: OpsPromotionArchiveQuery }>("/api/v1/ops/promotion-archive/release-audit-trail-record", {
    ...
    return releaseAuditTrailRecord;
  });
