      ...
      upstreamMarkers: {
        ...
        miniKvV97: {
          ...
          consumer: expect.stringMatching(
            /Node v23[13457] manual sandbox connection (preflight verification|rehearsal packet review|blocked execution rehearsal|precondition intake|readiness gate)/,
          ),
          consumedReleaseVersion: "v96",
          consumedMarkerDigest: "fnv1a64:b9fc556875ea625b",
          receiptDigest: "fnv1a64:f5c9fa97c073ba43",
          manualWindowFlagName: "ORDEROPS_MANAGED_AUDIT_MANUAL_SANDBOX_WINDOW_APPROVED",
