...
export function controlledReadOnlyShardPreviewCandidateDocumentRequestPackageFixture(
  ready: boolean,
) {
  return createControlledReadOnlyShardPreviewCandidateDocumentRequestPackage(
...
export function controlledReadOnlyShardPreviewCandidateDocumentSubmissionPrecheckFixture(
  ready: boolean,
) {
...
export function controlledReadOnlyShardPreviewCandidateDocumentMaterialRequestPackageFixture(
  ready: boolean,
) {
