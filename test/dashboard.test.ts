...
describe("dashboardHtml", () => {
  it("renders upstream overview detail panels for v56", () => {
    ...
    expect(html).toContain('id="scenarioArchiveVerificationValidSignal"');
    expect(html).toContain('id="scenarioArchiveVerificationDigestSignal"');
    expect(html).toContain('id="scenarioArchiveVerificationVerificationDigestSignal"');
    expect(html).toContain('id="scenarioArchiveVerificationReadOnlySignal"');
    expect(html).toContain('id="scenarioArchiveVerificationExecutionSignal"');
    expect(html).toContain('id="scenarioArchiveVerificationBundleValiditySignal"');
    expect(html).toContain('id="scenarioArchiveVerificationSourcePathSignal"');
    expect(html).toContain('id="scenarioArchiveVerificationScenarioEvidenceSignal"');
    expect(html).toContain('id="scenarioArchiveVerificationIssueSignal"');
    ...
    expect(html).toContain('data-action="scenarioArchiveVerificationMarkdown"');
