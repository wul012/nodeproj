...
| Maintainability ratchet | 91 near-limit files / 122 long functions / 238 complex functions / 2 runtime cycles; exact debt may only shrink | `npm run maintainability:census` | [v2204 census evidence](d/2204/evidence/maintainability-census-v2204-summary.json) |
