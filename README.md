...
- Local operation approval evidence report, verification, and handoff bundle for archiving request, decision, digest chain, Java approval-status evidence, mini-kv `side_effects`, and upstream untouched proof
