...
- Local operation approval evidence report, verification, and handoff bundle for archiving request, decision, digest chain, Java approval-status digest evidence, mini-kv `command_digest` / `side_effect_count`, and upstream untouched proof
