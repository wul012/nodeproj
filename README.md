...
[![Tests](https://img.shields.io/badge/tests-1731%20passing-brightgreen)](d/2208/evidence/sandbox-endpoint-echo-hotspot-v2208-summary.json)
...
|---|---:|---|---|
| Test suite | 1,731 / 1,731 tests passing | `npx vitest run` | [v2208 full-suite summary](d/2208/evidence/sandbox-endpoint-echo-hotspot-v2208-summary.json) |
...
| Maintainability ratchet | 87 near-limit files / 119 long functions / 233 complex functions / 2 runtime cycles; exact debt may only shrink | `npm run maintainability:census` | [v2208 hotspot evidence](d/2208/evidence/sandbox-endpoint-echo-hotspot-v2208-summary.json) |
