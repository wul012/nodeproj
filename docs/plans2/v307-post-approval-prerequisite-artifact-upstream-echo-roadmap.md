...
- v308 已完成；后续 Node v309 之前不再追加 Node-only review packet 小版本，避免 contract 链空转。
...
- Node v309 必须等待 Java v143 + mini-kv v136 都完成。

## 一句话结论

```text
v308 已完成人工 approval artifact review packet；下一步推荐并行 Java v143 + mini-kv v136，而不是 Node 抢跑 v309。
```
