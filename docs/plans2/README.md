...
```text
docs/plans2/v338-post-disabled-design-draft-body-candidate-archive-verification-roadmap.md
```
...
当前有效计划仍是 docs/plans2/v338-post-disabled-design-draft-body-candidate-archive-verification-roadmap.md；下一步是 Node v340。
