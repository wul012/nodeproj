...
```text
docs/plans2/v350-post-minimal-read-only-integration-passed-archive-verification-roadmap.md
```
...
当前有效计划是 docs/plans2/v344-post-disabled-design-draft-body-draft-candidate-archive-verification-roadmap.md；下一步是 Node v345，转向最小只读真实联调 readiness。
