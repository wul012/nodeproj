...
当前有效计划是 docs/plans2/v325-post-no-network-safety-fixture-prerequisite-closure-roadmap.md；下一步是推荐并行 Java v150 + mini-kv v142。
...
推荐并行：Java v150 + mini-kv v142。当前下一步；两边互不依赖，可以并行只读 echo / non-participation。
