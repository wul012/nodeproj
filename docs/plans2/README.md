...
Node v308：human approval artifact review packet。当前下一步；只定义人工 artifact review packet，不实现 runtime shell。
```
...
- Node v308 当前下一步，只能做 human approval artifact review packet，不得跳到 runtime shell implementation。
