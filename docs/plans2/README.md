...
下一步：Node v281 回到主流程，做 credential resolver approval-required implementation readiness review。
之后推荐并行：Java v116 + mini-kv v122；两边完成后 Node v282 做 upstream echo verification。
```
