...
```text
docs/plans2/v336-post-disabled-design-draft-body-intake-archive-verification-roadmap.md
```
...
当前有效计划切换到 docs/plans2/v338-post-disabled-design-draft-body-candidate-archive-verification-roadmap.md；下一步是 Node v339。
