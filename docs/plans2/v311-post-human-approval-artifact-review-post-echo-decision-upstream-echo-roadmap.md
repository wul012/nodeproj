...
```text
v311 已经完成三方 post-echo decision gate 对齐；v312 已完成 stop/prerequisite closure decision，当前只有出现新的具体 prerequisite contract 才请求 Java/mini-kv 新并行版本；否则 Node 只适合做质量优化。
```
