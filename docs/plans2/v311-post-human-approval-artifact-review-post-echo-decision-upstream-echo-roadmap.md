...
```text
v311 已经完成三方 post-echo decision gate 对齐；下一步 Node v312 应先做 stop/prerequisite closure decision，避免继续空转 echo，只有出现新的具体 prerequisite contract 才请求 Java/mini-kv 新并行版本。
```
