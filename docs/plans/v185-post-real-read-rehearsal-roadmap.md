...
6. 推荐并行：Java v67 + mini-kv v76，下一步执行。
...
7. Node v191：real HTTP read adapter rehearsal。
...
```text
v185 之后不要继续堆横向证据；先用 Node v186-v190 加速拆分最大技术债，再让 Java v67 + mini-kv v76 学习 Java v66 的真实只读能力节奏，最后由 Node v191 进入可关闭的真实读取 adapter rehearsal。
```
