...
计划状态：当前有效全局计划；上一份 `docs/plans/v156-post-read-only-window-capture-roadmap.md` 已完成，本文件从 Java v52 / mini-kv v61 / Node v160 开始。当前已推进到 Java v53 + mini-kv v62 推荐并行阶段。
...
3. 下一步推荐并行：Java v53 + mini-kv v62。
