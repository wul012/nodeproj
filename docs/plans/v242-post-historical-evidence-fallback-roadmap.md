...
3. Node v244：manual sandbox dry-run command upstream echo verification。
...
4. Node v245：sandbox connection precheck packet。
...
- Java v98 / mini-kv v107 未完成时，Node v244 必须停止。
