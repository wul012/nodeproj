...
| Integration capstone | v2191-v2192 | local four-project candidate PASS; external program-end review pending | v2191 independently reproduced C1-C3. v2192 adds the missing process-free aiproj artifact requirement, report schema v2, all three upstream commit pins, and a fixed-input C1-C4 live PASS under `d/2192/evidence/`. No maturity promotion or Stage 2 authority is claimed before review. |
