...
| README exhibition maintenance | v2202 | local gates complete; commit/tag/push and Node Evidence pending | Replaces the historical feature inventory with a 30-second evidence exhibit, keeps pinned maturity/boundary text byte-identical, links every metric to committed evidence, and archives desktop/mobile GFM validation. Focused docs 15/15, full Vitest 1716/1716, typecheck/build and all census gates are green; no runtime or capstone contract change. |
