...
| N1 | v2114+, v2119-v2126 | batch 1 committed and tagged (`v2114` / `0441f85a`); batches 2-9 completed as v2119-v2126; archive verification renderer subset now builder-backed | playbook progress table; `d/2119/evidence/renderer-consolidation-batch-2-v2119-summary.json`; `d/2120/evidence/renderer-consolidation-batch-3-v2120-summary.json`; `d/2121/evidence/renderer-consolidation-batch-4-v2121-summary.json`; `d/2122/evidence/renderer-consolidation-batch-5-v2122-summary.json`; `d/2123/evidence/renderer-consolidation-batch-6-v2123-summary.json`; `d/2124/evidence/renderer-consolidation-batch-7-v2124-summary.json`; `d/2125/evidence/renderer-consolidation-batch-8-v2125-summary.json`; `d/2126/evidence/renderer-consolidation-batch-9-v2126-summary.json` |
