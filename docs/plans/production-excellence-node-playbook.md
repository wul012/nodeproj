...
| N5 | v2187 | in progress; batch 1 of 3 | Fresh census corrected the historical estimate from 5 to 16 files over 800 lines. v2187 adds `scripts/source-size-census.mjs`, the shrink-only remediation baseline, and `test/sourceSizeRatchet.test.ts`; six static type/evidence boundaries reduce the reproducible oversized count from 16 to 10. Roadmap: `docs/plans/v2187-v2189-n5-source-size-health-roadmap.md`. |
