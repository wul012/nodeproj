...
```text
Node v374 已完成 minimal shard readiness regular gate，v370-v373 证据链已收束为 operator / CI 可消费门禁。
下一步 Node v375 是 regular gate archive verification，验证 v374 的 JSON、Markdown、summary、HTML、截图、解释、代码讲解和计划索引。
