...
Windows raw 与跨平台 `<repo>` 的 local、forced fallback、ready、blocked JSON/Markdown 摘要在改动
前后逐字一致，测试期望和 fixture 未修改。维护性账本收紧为 83 / 98 / 217 / 0，准确删除一个
...
43122 端口和 smoke 日志均已清理。远端 Node Evidence 仅在四版统一推送后触发一次。
