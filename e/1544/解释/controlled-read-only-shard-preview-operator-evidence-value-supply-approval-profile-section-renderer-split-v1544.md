# v1544 operator evidence value supply approval profile section renderer split

v1544 locks importsRuntimePayload and containsSecretValue as false in the extracted approval output.
