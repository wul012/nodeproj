# Node v1761 - ops promotion archive release deployment renderer split

## Focus

Extract the promotion release archive verification renderer into the release/archive module.
