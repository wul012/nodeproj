# Node v1722 - controlled read-only shard preview type module catalog entry group split

## Focus

Extract type module catalog interfaces into a dedicated types module.
