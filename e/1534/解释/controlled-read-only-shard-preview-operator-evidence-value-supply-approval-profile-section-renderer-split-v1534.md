# v1534 operator evidence value supply approval profile section renderer split

v1534 replaces the inline approval and capture section group with one approval profile section renderer delegation.
