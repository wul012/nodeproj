# Node v1727 - controlled read-only shard preview type module catalog entry group split

## Focus

Split text package preflight entries away from the long catalog chain.
