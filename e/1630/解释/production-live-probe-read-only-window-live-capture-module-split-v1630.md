# Node v1630 - production live probe read-only window live capture module split
...
This batch requires no fresh Java or mini-kv evidence and starts no sibling services; both can continue in parallel.
