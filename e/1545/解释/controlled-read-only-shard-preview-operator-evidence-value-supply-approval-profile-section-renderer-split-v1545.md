# v1545 operator evidence value supply approval profile section renderer split

v1545 records the value supply approval aggregator in the type module catalog.
