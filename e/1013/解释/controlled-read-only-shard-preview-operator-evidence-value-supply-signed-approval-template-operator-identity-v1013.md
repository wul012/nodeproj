# Node v1013 controlled read-only shard preview operator evidence value supply signed approval template: operator identity field

## What This Version Owns

v1013 owns the operator identity field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_OPERATOR_IDENTITY, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_OPERATOR_IDENTITY, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_OPERATOR_IDENTITY_REQUIRED.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_OPERATOR_IDENTITY
- Template field: SIGNED_APPROVAL_TEMPLATE_OPERATOR_IDENTITY
- Template clause: SIGNED_APPROVAL_TEMPLATE_OPERATOR_IDENTITY_REQUIRED
- Group: identity
