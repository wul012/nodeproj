# Node v1238 signed approval artifact draft text package review preflight

## What changed

Node v1238 contributes to the v1237-v1261 review preflight by covering the requester identity slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The identity slice keeps requester identity review separate from approval capture so no grant is inferred from metadata.
