# Node v1709 - production live probe read-only window capture release evidence review module split

## Focus

Reduce the original release review loader to orchestration only.
