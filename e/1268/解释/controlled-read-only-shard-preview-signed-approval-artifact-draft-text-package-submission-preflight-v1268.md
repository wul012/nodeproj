# Node v1268 signed approval artifact draft text package submission preflight

## What changed

Node v1268 contributes to the v1262-v1286 submission preflight by covering the digest slice: intake digest. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The digest slice keeps the v1236 intake digest reachable from the submission preflight and marks it as a digest-comparison pin.
