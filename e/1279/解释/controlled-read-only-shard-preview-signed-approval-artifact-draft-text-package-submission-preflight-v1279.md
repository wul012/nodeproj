# Node v1279 signed approval artifact draft text package submission preflight

## What changed

Node v1279 contributes to the v1262-v1286 submission preflight by covering the policy slice: reviewer separation. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The policy slice records reviewer-separation policy as a package comparison requirement instead of an approval grant.
