# Node v1273 signed approval artifact draft text package submission preflight

## What changed

Node v1273 contributes to the v1262-v1286 submission preflight by covering the source slice: Java evidence handle. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The source slice maps Java source evidence to a submission slot while documenting that no fresh Java evidence is required by Node.
