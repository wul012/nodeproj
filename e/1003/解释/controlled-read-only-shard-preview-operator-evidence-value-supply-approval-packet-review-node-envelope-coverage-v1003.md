# Node v1003 controlled read-only shard preview operator evidence value supply approval packet review: Node envelope coverage review control

## What This Version Owns

v1003 owns the Node envelope coverage review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_NODE_ENVELOPE_COVERAGE in the source-evidence group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_SLOT_COUNT.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_SLOT_COUNT
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_NODE_ENVELOPE_COVERAGE
