# Node v1730 - controlled read-only shard preview type module catalog entry group split

## Focus

Add the aggregate entry group registry for deterministic flattening.
