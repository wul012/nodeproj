# Node v1290 signed approval artifact draft text package comparison preflight

## What changed

Node v1290 contributes to the v1287-v1311 comparison preflight by covering the identity slice: approval intent. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The identity slice records the approval-intent comparison lane and blocks acceptance until a later submitted package comparison exists.
