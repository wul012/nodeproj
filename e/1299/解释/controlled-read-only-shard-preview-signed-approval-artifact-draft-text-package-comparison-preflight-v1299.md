# Node v1299 signed approval artifact draft text package comparison preflight

## What changed

Node v1299 contributes to the v1287-v1311 comparison preflight by covering the source slice: mini-kv evidence handle. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The source slice maps mini-kv source evidence to a comparison lane while documenting that no mini-kv service start is required.
