# Node v1277 signed approval artifact draft text package submission preflight

## What changed

Node v1277 contributes to the v1262-v1286 submission preflight by covering the value slice: value assertion. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The value slice adds the value assertion comparison guard without importing runtime payloads.
