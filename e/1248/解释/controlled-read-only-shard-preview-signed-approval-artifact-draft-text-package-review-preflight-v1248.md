# Node v1248 signed approval artifact draft text package review preflight

## What changed

Node v1248 contributes to the v1237-v1261 review preflight by covering the java source evidence handle slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The source evidence slice binds Java evidence handle review to frozen/historical evidence without starting Java.
