# Node v1658 - production live probe read-only window capture archive verification module split

## Focus

Preserve stable entrypoint type re-exports for release review consumers.
