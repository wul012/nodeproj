# Node v1712 - production live probe read-only window capture release evidence review module split

## Focus

Keep blocked release evidence review behavior covered after the split.
