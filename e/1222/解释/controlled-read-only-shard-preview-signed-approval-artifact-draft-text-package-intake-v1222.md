# Node v1222 signed approval artifact draft text package intake

## What changed

Node v1222 contributes to the v1212-v1236 text package intake profile by covering detached signature envelope metadata fields source evidence and archive reference fields operator value handle binding fields without value import policy, review state, and rejection-code fields execution lock, runtime, write, import, and sibling mutation guards.
