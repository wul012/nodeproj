...
v938 contributes Java response version to the Node v937-v961 value supply envelope package. It records Java v632 response version inside the v633 tagged closeout evidence.
