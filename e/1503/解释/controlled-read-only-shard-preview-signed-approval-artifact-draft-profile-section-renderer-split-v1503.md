# v1503 signed approval artifact draft profile section renderer split

v1503 removes five helper groups from the giant live-window renderer and replaces them with one delegation call.
