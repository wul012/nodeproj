# Node v1272 signed approval artifact draft text package submission preflight

## What changed

Node v1272 contributes to the v1262-v1286 submission preflight by covering the signature slice: signature timestamp. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The signature slice records the signature timestamp requirement as a pre-submission control instead of an execution permission.
