# Node v1594 - production live probe read-only window readiness packet module split

## Focus

endpoint constants extraction.

## What changed

Evidence endpoint constants moved out of the loader while the final profile still receives a copied object.
