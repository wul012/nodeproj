# Node v1028 controlled read-only shard preview operator evidence value supply signed approval template: draft-only packet policy field

## What This Version Owns

v1028 owns the draft-only packet policy field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_PACKET_POLICY, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_ONLY_POLICY, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_PACKET_POLICY_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_ONLY_POLICY
- Template field: SIGNED_APPROVAL_TEMPLATE_PACKET_POLICY
- Template clause: SIGNED_APPROVAL_TEMPLATE_PACKET_POLICY_BOUND
- Group: policy
