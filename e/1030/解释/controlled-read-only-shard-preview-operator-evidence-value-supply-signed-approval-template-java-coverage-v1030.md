# Node v1030 controlled read-only shard preview operator evidence value supply signed approval template: Java evidence coverage field

## What This Version Owns

v1030 owns the Java evidence coverage field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_JAVA_EVIDENCE_COVERAGE, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_JAVA_EVIDENCE_COVERAGE, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_JAVA_COVERAGE_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_JAVA_EVIDENCE_COVERAGE
- Template field: SIGNED_APPROVAL_TEMPLATE_JAVA_EVIDENCE_COVERAGE
- Template clause: SIGNED_APPROVAL_TEMPLATE_JAVA_COVERAGE_BOUND
