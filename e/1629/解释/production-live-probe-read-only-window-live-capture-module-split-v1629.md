# Node v1629 - production live probe read-only window live capture module split

## Focus

adjacent chain verification.

## What changed

Readiness packet and capture archive tests remain the adjacent chain guard for this split.
