# Node v1036 controlled read-only shard preview operator evidence value supply signed approval template: signed approval template closeout field

## What This Version Owns

v1036 owns the signed approval template closeout field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_CLOSEOUT, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_CLOSEOUT, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_CLOSEOUT_ONLY.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_CLOSEOUT
- Template field: SIGNED_APPROVAL_TEMPLATE_CLOSEOUT
- Template clause: SIGNED_APPROVAL_TEMPLATE_CLOSEOUT_ONLY
- Group: closeout
