# v1483 signed approval artifact draft profile section renderer split

v1483 adds the signed approval artifact draft profile section renderer as a dedicated module owned by the draft artifact route sections.
