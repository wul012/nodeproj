...
- Generated at: 2026-05-30T00:15:43.969Z
- Profile version: managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-declared-operator-lifecycle-runtime-live-read-gate-plan.v1
- Plan state: java-mini-kv-declared-operator-lifecycle-runtime-live-read-gate-plan-ready
- Plan decision: write-separate-runtime-live-read-gate-plan-after-v389-archive-verification
- Active Node version: Node v390
- Source Node version: Node v389
- Ready for Node v391 archive verification: true
- Ready for runtime live-read gate: false
- Runtime gate plan only: true
- Operator approval record required: true
- Concrete loopback ports required: true
- GET-only smoke command required: true
- Cleanup proof required: true
...
- archiveVerificationDigest: a86ed664d69a44db33601e52b121df819d035643be5f0f2f9cde3a87b0cbea12
- checkCount: 38
- passedCheckCount: 38
- sourceCheckCount: 45
...
- replayState: ready
- replayedProfileVersion: managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-declared-operator-lifecycle-evidence-intake-archive-verification.v1
- readyForDeclaredOperatorLifecycleEvidenceIntakeArchiveVerification: true
- readyForNodeV390RuntimeGatePlan: true
- readyForRuntimeLiveReadGate: false
- archiveVerificationOnly: true
...
- replayState: ready
- replayedProfileVersion: managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-declared-operator-lifecycle-evidence-intake.v1
...
- sourceNodeV389ArchiveVerificationDigest: a86ed664d69a44db33601e52b121df819d035643be5f0f2f9cde3a87b0cbea12
- sourceNodeV388ReplayProfileVersion: managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-declared-operator-lifecycle-evidence-intake.v1
...
- activeShardPrototypeEnabled: false
- ready: true
- planDigest: 89d38b4b2375e6e30b0655a517a748422f640e43e622c1236639748cfe0f830d
...
- RUNTIME_LIVE_READ_GATE_PLAN_IS_NOT_EXECUTION (warning, node-v390): v390 writes a separate runtime gate plan only; it does not start Java, start mini-kv, or run probes.

## Recommendations

- ARCHIVE_V390_BEFORE_RUNTIME_PACKET (recommendation, node-v390): Archive and verify v390 before preparing any runtime execution packet.
