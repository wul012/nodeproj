# Node v1009 controlled read-only shard preview operator evidence value supply approval packet review: write and service block review control

## What This Version Owns

v1009 owns the write and service block review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_WRITE_AND_SERVICE_BLOCK in the execution-lock group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_NO_PERSIST.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_NO_PERSIST
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_WRITE_AND_SERVICE_BLOCK
