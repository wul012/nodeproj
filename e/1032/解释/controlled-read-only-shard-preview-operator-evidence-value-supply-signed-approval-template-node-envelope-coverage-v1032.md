# Node v1032 controlled read-only shard preview operator evidence value supply signed approval template: Node envelope coverage field

## What This Version Owns

v1032 owns the Node envelope coverage field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_NODE_ENVELOPE_COVERAGE, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_NODE_ENVELOPE_COVERAGE, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_NODE_ENVELOPE_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_NODE_ENVELOPE_COVERAGE
- Template field: SIGNED_APPROVAL_TEMPLATE_NODE_ENVELOPE_COVERAGE
- Template clause: SIGNED_APPROVAL_TEMPLATE_NODE_ENVELOPE_BOUND
