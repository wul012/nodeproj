# Node v1031 controlled read-only shard preview operator evidence value supply signed approval template: mini-kv evidence coverage field

## What This Version Owns

v1031 owns the mini-kv evidence coverage field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_MINI_KV_EVIDENCE_COVERAGE, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_MINI_KV_EVIDENCE_COVERAGE, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_MINI_KV_COVERAGE_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_MINI_KV_EVIDENCE_COVERAGE
- Template field: SIGNED_APPROVAL_TEMPLATE_MINI_KV_EVIDENCE_COVERAGE
- Template clause: SIGNED_APPROVAL_TEMPLATE_MINI_KV_COVERAGE_BOUND
