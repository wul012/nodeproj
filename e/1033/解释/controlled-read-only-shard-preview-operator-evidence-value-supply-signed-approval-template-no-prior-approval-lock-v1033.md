# Node v1033 controlled read-only shard preview operator evidence value supply signed approval template: no prior approval lock field

## What This Version Owns

v1033 owns the no prior approval lock field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_NO_APPROVAL_CAPTURED_LOCK, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_NO_APPROVAL_CAPTURED, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_NO_PRIOR_APPROVAL_LOCK.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_NO_APPROVAL_CAPTURED
- Template field: SIGNED_APPROVAL_TEMPLATE_NO_APPROVAL_CAPTURED_LOCK
- Template clause: SIGNED_APPROVAL_TEMPLATE_NO_PRIOR_APPROVAL_LOCK
- Group: execution-lock
