# Node v1689 - production live probe read-only window capture release evidence review module split

## Focus

Extract the release evidence review build-parts boundary.
