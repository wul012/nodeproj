# Node v1255 signed approval artifact draft text package review preflight

## What changed

Node v1255 contributes to the v1237-v1261 review preflight by covering the rejection code assertion slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The policy slice makes rejection reasons reviewable before any manual approval grant is accepted.
