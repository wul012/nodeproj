# Node v1659 - production live probe read-only window capture archive verification module split

## Focus

Extract the capture archive verification build-parts boundary.
