# Node v1708 - production live probe read-only window capture release evidence review module split

## Focus

Keep stable Markdown renderer re-export from the release review entrypoint.
