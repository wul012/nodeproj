# Node v990 controlled read-only shard preview operator evidence value supply approval packet review: source evidence version review control

## What This Version Owns

v990 owns the source evidence version review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_SOURCE_EVIDENCE_VERSION in the approval-field group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_JAVA_READY_ENVELOPE.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_JAVA_READY_ENVELOPE
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_SOURCE_EVIDENCE_VERSION
