# Node v991 controlled read-only shard preview operator evidence value supply approval packet review: typed value shape review control

## What This Version Owns

v991 owns the typed value shape review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_VALUE_SHAPE in the approval-field group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_JAVA_SUPPLIED_STATE.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_JAVA_SUPPLIED_STATE
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_VALUE_SHAPE
