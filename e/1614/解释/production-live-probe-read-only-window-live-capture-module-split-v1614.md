# Node v1614 - production live probe read-only window live capture module split

## Focus

capture state resolver extraction.

## What changed

Captured pass, skipped, mixed, and blocked state selection now lives with builder safety logic.
