# Node v1584 - production live probe read-only window readiness packet module split
...
The loader now receives a cohesive build result instead of assembling checks, state, digest, messages, and summary inline.
