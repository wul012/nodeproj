# Node v1262 signed approval artifact draft text package submission preflight

## What changed

Node v1262 contributes to the v1262-v1286 submission preflight by covering the identity slice: request manifest. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The identity slice opens the manual submission surface with the request manifest slot and a comparison control that rejects missing package material before any signed draft text can be accepted.
