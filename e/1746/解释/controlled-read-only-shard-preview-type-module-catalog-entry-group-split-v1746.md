# Node v1746 - controlled read-only shard preview type module catalog entry group split

## Focus

Record the no-service-startup constraint for this maintainability batch.
