# Node v1278 signed approval artifact draft text package submission preflight

## What changed

Node v1278 contributes to the v1262-v1286 submission preflight by covering the policy slice: policy assertion. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The policy slice turns policy readiness into a submission slot and blocks acceptance until a later package comparison exists.
