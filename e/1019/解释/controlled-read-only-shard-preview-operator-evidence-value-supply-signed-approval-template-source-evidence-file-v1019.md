# Node v1019 controlled read-only shard preview operator evidence value supply signed approval template: source evidence file field

## What This Version Owns

v1019 owns the source evidence file field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_SOURCE_EVIDENCE_FILE, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_JAVA_EVIDENCE_COVERAGE, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_SOURCE_FILE_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_JAVA_EVIDENCE_COVERAGE
- Template field: SIGNED_APPROVAL_TEMPLATE_SOURCE_EVIDENCE_FILE
- Template clause: SIGNED_APPROVAL_TEMPLATE_SOURCE_FILE_BOUND
