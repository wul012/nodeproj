# Node v1269 signed approval artifact draft text package submission preflight

## What changed

Node v1269 contributes to the v1262-v1286 submission preflight by covering the digest slice: source digest. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The digest slice closes the digest family with a read-only source digest slot and comparison control.
