# Node v1243 signed approval artifact draft text package review preflight

## What changed

Node v1243 contributes to the v1237-v1261 review preflight by covering the draft instruction digest slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The digest slice links the submitted-package review path back to the instruction preflight digest.
