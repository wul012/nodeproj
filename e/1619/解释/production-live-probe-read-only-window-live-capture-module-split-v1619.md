# Node v1619 - production live probe read-only window live capture module split

## Focus

record count summary assembly.

## What changed

Captured, pass, skipped, blocked, blocker, warning, and recommendation counts are produced by the builder result.
