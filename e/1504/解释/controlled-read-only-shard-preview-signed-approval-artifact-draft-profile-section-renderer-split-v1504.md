# v1504 signed approval artifact draft profile section renderer split

v1504 confirms the range adds no live startup requirement, no sibling write, and no real approval execution.
