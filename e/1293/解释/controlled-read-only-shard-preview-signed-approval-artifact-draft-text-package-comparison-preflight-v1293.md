# Node v1293 signed approval artifact draft text package comparison preflight

## What changed

Node v1293 contributes to the v1287-v1311 comparison preflight by covering the digest slice: intake digest. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The digest slice keeps the v1236 intake digest reachable from the comparison preflight and marks it as a digest recheck lane.
