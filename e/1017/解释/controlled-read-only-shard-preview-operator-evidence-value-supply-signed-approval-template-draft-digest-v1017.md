# Node v1017 controlled read-only shard preview operator evidence value supply signed approval template: source draft digest field

## What This Version Owns

v1017 owns the source draft digest field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_DRAFT_DIGEST, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_DIGEST_COVERAGE, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_DRAFT_DIGEST_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_DIGEST_COVERAGE
- Template field: SIGNED_APPROVAL_TEMPLATE_DRAFT_DIGEST
- Template clause: SIGNED_APPROVAL_TEMPLATE_DRAFT_DIGEST_BOUND
