# v1501 signed approval artifact draft profile section renderer split

v1501 checks that the public route Markdown still includes signed approval artifact draft sections.
