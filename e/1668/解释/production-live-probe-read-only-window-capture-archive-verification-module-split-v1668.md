# Node v1668 - production live probe read-only window capture archive verification module split

## Focus

Keep archive profile version and archive readiness checks inside the builder.
