# Node v1245 signed approval artifact draft text package review preflight

## What changed

Node v1245 contributes to the v1237-v1261 review preflight by covering the detached signature envelope slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The signature slice checks detached signature envelope metadata while blocking raw signature payload parsing.
