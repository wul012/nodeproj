# Node v1700 - production live probe read-only window capture release evidence review module split

## Focus

Keep skipped or mixed capture non-pass policy checks inside the builder.
