# Node v1669 - production live probe read-only window capture archive verification module split

## Focus

Keep upstream Java and mini-kv reference readiness checks inside the builder.
