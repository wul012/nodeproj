# Node v1306 signed approval artifact draft text package comparison preflight

## What changed

Node v1306 contributes to the v1287-v1311 comparison preflight by covering the execution lock slice: no runtime payload. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The execution lock slice adds the runtime-payload blocker to the acceptance control surface.
