# Node v1239 signed approval artifact draft text package review preflight

## What changed

Node v1239 contributes to the v1237-v1261 review preflight by covering the signer identity slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The identity slice requires later reviewer confirmation of signer metadata while raw signature bodies remain out of scope.
