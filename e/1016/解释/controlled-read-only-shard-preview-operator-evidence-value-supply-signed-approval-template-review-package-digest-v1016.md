# Node v1016 controlled read-only shard preview operator evidence value supply signed approval template: source review package digest field

## What This Version Owns

v1016 owns the source review package digest field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_REVIEW_PACKAGE_DIGEST, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_DIGEST_COVERAGE, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_REVIEW_DIGEST_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_DIGEST_COVERAGE
- Template field: SIGNED_APPROVAL_TEMPLATE_REVIEW_PACKAGE_DIGEST
- Template clause: SIGNED_APPROVAL_TEMPLATE_REVIEW_DIGEST_BOUND
