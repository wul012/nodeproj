# Node v1001 controlled read-only shard preview operator evidence value supply approval packet review: Java evidence coverage review control

## What This Version Owns

v1001 owns the Java evidence coverage review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_JAVA_EVIDENCE_COVERAGE in the source-evidence group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_RANGE_START.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_RANGE_START
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_JAVA_EVIDENCE_COVERAGE
