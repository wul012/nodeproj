# Node v1292 signed approval artifact draft text package comparison preflight

## What changed

Node v1292 contributes to the v1287-v1311 comparison preflight by covering the digest slice: review digest. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The digest slice carries the review digest binding into a comparison lane and keeps compared package counts at zero.
