# Node v1641 - production live probe read-only window capture archive module split

## Focus

Preserve capture archive digest generation over the same stable input shape.
