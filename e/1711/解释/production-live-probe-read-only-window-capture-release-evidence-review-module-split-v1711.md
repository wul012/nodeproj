# Node v1711 - production live probe read-only window capture release evidence review module split

## Focus

Keep Java v51 and mini-kv v60 field guide behavior coverage after the split.
