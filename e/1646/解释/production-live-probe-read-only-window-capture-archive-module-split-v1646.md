# Node v1646 - production live probe read-only window capture archive module split

## Focus

Extract capture archive Markdown rendering into a dedicated renderer module.
