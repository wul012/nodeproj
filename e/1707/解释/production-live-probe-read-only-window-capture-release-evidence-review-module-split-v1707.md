# Node v1707 - production live probe read-only window capture release evidence review module split

## Focus

Extract release evidence review Markdown rendering into a dedicated renderer module.
