# Node v1250 signed approval artifact draft text package review preflight

## What changed

Node v1250 contributes to the v1237-v1261 review preflight by covering the node source evidence handle slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The source evidence slice keeps Node-side source evidence reviewable through stable digests and archive references.
