# Node v1706 - production live probe read-only window capture release evidence review module split

## Focus

Move release review summary count assembly into the builder.
