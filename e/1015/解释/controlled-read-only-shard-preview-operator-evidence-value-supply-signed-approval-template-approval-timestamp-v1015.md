# Node v1015 controlled read-only shard preview operator evidence value supply signed approval template: approval timestamp field

## What This Version Owns

v1015 owns the approval timestamp field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_APPROVAL_TIMESTAMP, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_APPROVAL_TIMESTAMP, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_TIMESTAMP_REQUIRED.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_APPROVAL_TIMESTAMP
- Template field: SIGNED_APPROVAL_TEMPLATE_APPROVAL_TIMESTAMP
- Template clause: SIGNED_APPROVAL_TEMPLATE_TIMESTAMP_REQUIRED
- Group: time
