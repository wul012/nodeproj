# Node v1738 - controlled read-only shard preview type module catalog entry group split

## Focus

Keep controlled read-only shard preview route tests passing through the split.
