# Node v1662 - production live probe read-only window capture archive verification module split

## Focus

Reuse capture archive Java v50 and mini-kv v59 reference constants instead of duplicating tag strings.
