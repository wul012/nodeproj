# v1578 operator evidence value supply profile section renderer split

v1578 documents that Java and mini-kv can continue in parallel without fresh evidence for this renderer split.
