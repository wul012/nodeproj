# Node v1225 signed approval artifact draft text package intake

## What changed

Node v1225 contributes to the v1212-v1236 text package intake profile by covering source evidence and archive reference fields operator value handle binding fields without value import policy, review state, and rejection-code fields execution lock, runtime, write, import, and sibling mutation guards.
