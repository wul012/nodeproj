# Node v1252 signed approval artifact draft text package review preflight

## What changed

Node v1252 contributes to the v1237-v1261 review preflight by covering the operator value digest slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The value binding slice requires value digest review before any future value-supply flow can proceed.
