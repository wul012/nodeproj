# Node v1296 signed approval artifact draft text package comparison preflight

## What changed

Node v1296 contributes to the v1287-v1311 comparison preflight by covering the signature slice: signature signer. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The signature slice separates signer identity comparison from package acceptance and keeps approvalCaptured=false.
