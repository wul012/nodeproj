# Node v936 controlled read-only shard preview operator evidence fresh sibling intake: batch closeout

## What This Version Owns

v936 contributes batch closeout to the Node v912-v936 fresh sibling intake package. The slice is owned by Node evidence consumption, but the implementation lives only in Node and reads committed sibling files through historical fallback-aware evidence helpers.

Detail: closes the Node v912-v936 intake by tying Java v608, mini-kv v560, and Node v911 value draft evidence together.
