# Node v999 controlled read-only shard preview operator evidence value supply approval packet review: redaction policy review control

## What This Version Owns

v999 owns the redaction policy review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_REDACTION_POLICY in the policy group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_CONTRACT.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_CONTRACT
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_REDACTION_POLICY
