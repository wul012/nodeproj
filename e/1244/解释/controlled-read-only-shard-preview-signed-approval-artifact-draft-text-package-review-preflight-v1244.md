# Node v1244 signed approval artifact draft text package review preflight

## What changed

Node v1244 contributes to the v1237-v1261 review preflight by covering the draft package digest slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The digest slice requires the later package digest to remain lowercase sha256 and independently reviewable.
