# Node v1764 - ops promotion archive release deployment renderer split

## Focus

Extract the deployment approval verification renderer into the approval/change module.
