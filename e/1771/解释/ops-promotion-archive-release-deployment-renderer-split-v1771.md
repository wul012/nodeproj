# Node v1771 - ops promotion archive release deployment renderer split

## Focus

Extract the deployment execution receipt verification renderer into the execution/receipt module.
