# Node v1298 signed approval artifact draft text package comparison preflight

## What changed

Node v1298 contributes to the v1287-v1311 comparison preflight by covering the source slice: Java evidence handle. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The source slice maps Java source evidence to a comparison lane while documenting that no fresh Java evidence is required by Node.
