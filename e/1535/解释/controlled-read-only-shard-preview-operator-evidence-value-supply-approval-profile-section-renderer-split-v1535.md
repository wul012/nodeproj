# v1535 operator evidence value supply approval profile section renderer split

v1535 adds a small approval profile section renderer aggregator for packet/template and capture subsections.
