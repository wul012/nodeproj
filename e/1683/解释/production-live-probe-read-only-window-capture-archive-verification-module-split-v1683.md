# Node v1683 - production live probe read-only window capture archive verification module split

## Focus

Validate the release evidence review consumer after the split.
