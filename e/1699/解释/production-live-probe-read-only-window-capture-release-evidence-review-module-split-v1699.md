# Node v1699 - production live probe read-only window capture release evidence review module split

## Focus

Keep non-pass-only field guide policy checks inside the builder.
