# Node v1766 - ops promotion archive release deployment renderer split

## Focus

Extract the deployment change record verification renderer into the approval/change module.
