# Node v1718 - production live probe read-only window capture release evidence review module split

## Focus

Run HTTP smoke for release evidence review JSON and Markdown.
