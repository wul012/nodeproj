# Node v1635 - production live probe read-only window capture archive module split

## Focus

Move capture archive evidence endpoint constants into the builder module.
