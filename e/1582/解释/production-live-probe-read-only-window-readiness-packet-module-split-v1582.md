# Node v1582 - production live probe read-only window readiness packet module split

## Focus

profile and nested evidence/message type extraction.

## What changed

The profile contract now lives in a dedicated type module so later builders and renderers can import it without pulling in loader side effects.
