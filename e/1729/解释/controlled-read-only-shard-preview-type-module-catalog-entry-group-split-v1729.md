# Node v1729 - controlled read-only shard preview type module catalog entry group split

## Focus

Move candidate document and profile section entries into their own group module.
