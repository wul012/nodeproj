# Node v1660 - production live probe read-only window capture archive verification module split

## Focus

Move expected capture archive digest recomputation into the builder.
