# Node v1905 - implementation plan upstream echo module split
...
Constants now own the profile, route, evidence path, boundary, artifact, action, and requirement catalogs.
