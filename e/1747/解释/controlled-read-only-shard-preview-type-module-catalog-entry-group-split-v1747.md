# Node v1747 - controlled read-only shard preview type module catalog entry group split

## Focus

Document the six catalog entry groups as the new ownership boundary.
