# Node v1280 signed approval artifact draft text package submission preflight

## What changed

Node v1280 contributes to the v1262-v1286 submission preflight by covering the policy slice: review state. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The policy slice carries review-state readiness forward while keeping reviewed/approved/rejected package counts at zero.
