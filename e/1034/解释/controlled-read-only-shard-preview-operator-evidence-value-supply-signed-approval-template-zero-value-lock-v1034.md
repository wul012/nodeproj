# Node v1034 controlled read-only shard preview operator evidence value supply signed approval template: zero value count lock field

## What This Version Owns

v1034 owns the zero value count lock field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_ZERO_VALUE_COUNT_LOCK, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_ZERO_VALUE_COUNTS, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_ZERO_VALUE_LOCK.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_ZERO_VALUE_COUNTS
- Template field: SIGNED_APPROVAL_TEMPLATE_ZERO_VALUE_COUNT_LOCK
- Template clause: SIGNED_APPROVAL_TEMPLATE_ZERO_VALUE_LOCK
