# Node v1161 signed approval artifact draft review package preflight explanation

Node v1161 adds the review package closeout slot for the controlled read-only shard preview signed approval chain.

## What changed

- Package slot: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_REVIEW_PACKAGE_PREFLIGHT_CLOSEOUT_SLOT
- Package guard: ARTIFACT_DRAFT_REVIEW_PACKAGE_PREFLIGHT_CLOSEOUT_GUARD
- Purpose: closes the preflight and requires separate human draft artifact authoring.
