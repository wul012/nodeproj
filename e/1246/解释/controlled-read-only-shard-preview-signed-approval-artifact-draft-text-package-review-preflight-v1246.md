# Node v1246 signed approval artifact draft text package review preflight

## What changed

Node v1246 contributes to the v1237-v1261 review preflight by covering the signature algorithm metadata slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The signature slice keeps algorithm metadata reviewable without allowing private key or signature material into Node.
