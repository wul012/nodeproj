# Node v1302 signed approval artifact draft text package comparison preflight

## What changed

Node v1302 contributes to the v1287-v1311 comparison preflight by covering the value slice: value assertion. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The value slice adds the value assertion acceptance guard without importing runtime payloads.
