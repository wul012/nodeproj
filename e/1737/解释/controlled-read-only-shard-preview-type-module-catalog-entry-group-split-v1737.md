# Node v1737 - controlled read-only shard preview type module catalog entry group split

## Focus

Keep Markdown renderer output stable over the new aggregate entrypoint.
