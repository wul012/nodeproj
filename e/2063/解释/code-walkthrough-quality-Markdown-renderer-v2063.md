# Node v2063 explanation: code walkthrough quality Markdown renderer

Rendered the quality profile as Markdown using the shared audit profile formatting helpers.
