# Node v1176 signed approval artifact draft authoring readiness explanation

Node v1176 adds the source evidence snippet authoring requirement for the controlled read-only shard preview signed approval chain.

## What changed

- Authoring requirement: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_SOURCE_SNIPPET
- Authoring blocker: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_SOURCE_SNIPPET_BLOCKER
- Category: source evidence
- Source binding: source snippet package slot and guard from Node v1161 review package preflight.
- Purpose: keeps source snippet id visible for manual review without assembling a signed draft artifact.
