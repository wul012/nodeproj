# Node v1261 signed approval artifact draft text package review preflight

## What changed

Node v1261 contributes to the v1237-v1261 review preflight by covering the archive closeout slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The archive slice summarizes the review preflight and records that the next step is manual artifact submission.
