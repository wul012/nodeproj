# Node v1300 signed approval artifact draft text package comparison preflight

## What changed

Node v1300 contributes to the v1287-v1311 comparison preflight by covering the source slice: historical fixture fallback. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The source slice keeps historical fixture fallback evidence visible for GitHub runner compatibility.
