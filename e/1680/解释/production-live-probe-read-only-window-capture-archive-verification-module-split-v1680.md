# Node v1680 - production live probe read-only window capture archive verification module split

## Focus

Keep skipped capture archive verification behavior covered after the split.
