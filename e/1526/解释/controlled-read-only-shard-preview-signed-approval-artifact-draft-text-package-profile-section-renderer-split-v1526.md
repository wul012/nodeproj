# v1526 signed approval artifact draft text package profile section renderer split

v1526 moves profile-entry-types to catalog order 214 while preserving it as the final stable entry.
