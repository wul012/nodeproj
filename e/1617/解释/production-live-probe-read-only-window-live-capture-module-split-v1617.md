# Node v1617 - production live probe read-only window live capture module split

## Focus

recommendation generation extraction.

## What changed

Pass-capture archive and non-pass local-evidence recommendations moved into the builder result.
