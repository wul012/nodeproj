# Node v1678 - production live probe read-only window capture archive verification module split

## Focus

Reduce the original capture archive verification loader to orchestration only.
