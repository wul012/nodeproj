...
v941 contributes Java actual value state to the Node v937-v961 value supply envelope package. It pins actualValueState=not-supplied before any value supply path exists.
