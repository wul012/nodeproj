# Node v1267 signed approval artifact draft text package submission preflight

## What changed

Node v1267 contributes to the v1262-v1286 submission preflight by covering the digest slice: review digest. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The digest slice carries the review digest binding from v1261 into a submission slot and keeps submitted package counts at zero.
