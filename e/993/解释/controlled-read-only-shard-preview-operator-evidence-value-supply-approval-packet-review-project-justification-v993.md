# Node v993 controlled read-only shard preview operator evidence value supply approval packet review: project justification review control

## What This Version Owns

v993 owns the project justification review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_PROJECT_JUSTIFICATION in the approval-field group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_JAVA_PROVENANCE_STATE.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_JAVA_PROVENANCE_STATE
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_PROJECT_JUSTIFICATION
