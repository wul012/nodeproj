...
- Generated at: 2026-05-31T05:59:43.233Z
- Profile version: managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-runtime-execution-live-read-gate.v1
- Gate state: runtime-execution-live-read-gate-ready
- Gate decision: accept-approved-local-loopback-get-only-live-read-gate-for-next-smoke
- Active Node version: Node v406
- Source Node version: Node v405
- Java source version: Java v167
- mini-kv source version: mini-kv v158
- Ready for runtime execution live-read gate: true
...
- cleanupRule: stop-only-owned-java-processes
- localLoopbackOnly: true
- getOnly: true
- concretePortAssigned: true
...
- method: GET
- path: /health
- cleanupRule: stop-only-owned-mini-kv-processes
- localLoopbackOnly: true
- getOnly: true
- concretePortAssigned: true
- nodeStartsService: false
...
- gateDigest: 33f6b1f2de32026919703af2ed8841dbb119592af97802fc3e854f39f677c00f
...
- LIVE_READ_GATE_IS_NOT_RUNTIME_SMOKE (warning, node-v406): v406 accepts the live-read gate for the next smoke run; it still does not start Java or mini-kv.

## Recommendations

- RUN_APPROVED_LOOPBACK_SMOKE_NEXT (recommendation, node-v406): Run Node v407 as an approved local-loopback, GET-only, read-only smoke with explicit owned-process cleanup proof.

## Evidence Endpoints

- liveReadGateJson: /api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-runtime-execution-live-read-gate
- liveReadGateMarkdown: /api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-runtime-execution-live-read-gate?format=markdown
- sourceNodeV405Json: /api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-runtime-execution-canonical-approval-input-value-validation
- sourceNodeV405Markdown: /api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-java-mini-kv-runtime-execution-canonical-approval-input-value-validation?format=markdown
- activePlan: docs/plans3/v406-post-java-mini-kv-runtime-execution-live-read-gate-roadmap.md
- nextPlan: docs/plans3/v407-post-java-mini-kv-runtime-execution-approved-local-loopback-read-only-smoke-roadmap.md
