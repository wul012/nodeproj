# Node v1021 controlled read-only shard preview operator evidence value supply signed approval template: typed value shape field

## What This Version Owns

v1021 owns the typed value shape field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_VALUE_SHAPE, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_VALUE_SHAPE, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_VALUE_SHAPE_REQUIRED.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_VALUE_SHAPE
- Template field: SIGNED_APPROVAL_TEMPLATE_VALUE_SHAPE
- Template clause: SIGNED_APPROVAL_TEMPLATE_VALUE_SHAPE_REQUIRED
- Group: value-shape
