...
v960 contributes mini-kv no write test to the Node v937-v961 value supply envelope package. It uses the focused test to prove the value draft command leaves store state unchanged.
