# Node v1728 - controlled read-only shard preview type module catalog entry group split

## Focus

Split text package evidence entries into a second focused group module.
