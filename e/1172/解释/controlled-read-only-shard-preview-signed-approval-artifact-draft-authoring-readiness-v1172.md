# Node v1172 signed approval artifact draft authoring readiness explanation

Node v1172 adds the signature redaction authoring requirement for the controlled read-only shard preview signed approval chain.

## What changed

- Authoring requirement: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_SIGNATURE_REDACTION
- Authoring blocker: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_SIGNATURE_REDACTION_BLOCKER
- Category: signature envelope
- Source binding: signature redaction package slot and guard from Node v1161 review package preflight.
- Purpose: carries signature redaction policy while raw signature material stays blocked.
