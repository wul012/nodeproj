# Node v1726 - controlled read-only shard preview type module catalog entry group split

## Focus

Move signed approval capture draft entries into their own group module.
