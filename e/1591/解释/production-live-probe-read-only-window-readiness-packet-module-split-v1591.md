# Node v1591 - production live probe read-only window readiness packet module split

## Focus

warning and recommendation extraction.

## What changed

Readiness warnings and recommendations now sit with the builder result, keeping the loader focused on profile assembly.
