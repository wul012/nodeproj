# Node v1702 - production live probe read-only window capture release evidence review module split

## Focus

Keep no-execution-authorization review check inside the builder.
