# Node v1695 - production live probe read-only window capture release evidence review module split

## Focus

Move release evidence review check assembly into the builder.
