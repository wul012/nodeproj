# Node v1696 - production live probe read-only window capture release evidence review module split

## Focus

Keep ready-for-read-only-capture-release-evidence-review evaluation inside the builder.
