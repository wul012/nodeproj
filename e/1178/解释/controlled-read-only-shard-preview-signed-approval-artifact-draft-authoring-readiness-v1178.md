# Node v1178 signed approval artifact draft authoring readiness explanation

Node v1178 adds the value shape authoring requirement for the controlled read-only shard preview signed approval chain.

## What changed

- Authoring requirement: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_VALUE_SHAPE
- Authoring blocker: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_VALUE_SHAPE_BLOCKER
- Category: value binding
- Source binding: value shape package slot and guard from Node v1161 review package preflight.
- Purpose: exposes value shape metadata without accepting operator-supplied values.
