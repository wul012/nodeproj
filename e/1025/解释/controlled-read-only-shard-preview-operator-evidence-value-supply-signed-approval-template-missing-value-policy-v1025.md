# Node v1025 controlled read-only shard preview operator evidence value supply signed approval template: missing value policy field

## What This Version Owns

v1025 owns the missing value policy field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_MISSING_VALUE_POLICY, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_MISSING_VALUE_POLICY, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_MISSING_VALUE_POLICY_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_MISSING_VALUE_POLICY
- Template field: SIGNED_APPROVAL_TEMPLATE_MISSING_VALUE_POLICY
- Template clause: SIGNED_APPROVAL_TEMPLATE_MISSING_VALUE_POLICY_BOUND
- Group: policy
