# v874 Controlled read-only shard preview operator evidence import preflight cleanup coverage

v874 adds `IMPORT_PREFLIGHT_CLEANUP_COVERAGE` to the operator evidence import preflight chain. It consumes `ENTRY_WORKSHEET_CLEANUP_COVERAGE` from the v861 manual evidence entry worksheet and preserves cleanup coverage as an import preflight blocker.
...
No screenshot is needed because v874 adds service artifacts and Markdown route content without a new browser page.
