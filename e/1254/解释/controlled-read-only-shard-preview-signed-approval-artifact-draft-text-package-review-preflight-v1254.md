# Node v1254 signed approval artifact draft text package review preflight

## What changed

Node v1254 contributes to the v1237-v1261 review preflight by covering the review state assertion slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The policy slice requires later reviewer state to be explicit instead of inferred from package presence.
