# Node v1762 - ops promotion archive release deployment renderer split

## Focus

Move release evidence and release archive item helpers behind the release/archive renderer boundary.
