# Node v1247 signed approval artifact draft text package review preflight

## What changed

Node v1247 contributes to the v1237-v1261 review preflight by covering the signature timestamp metadata slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The signature slice requires timestamp metadata to be reviewed out of band before any approval grant is considered.
