# Node v994 controlled read-only shard preview operator evidence value supply approval packet review: signed human policy review control

## What This Version Owns

v994 owns the signed human policy review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_SIGNED_HUMAN_POLICY in the policy group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_JAVA_SUBMISSION_BLOCK.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_JAVA_SUBMISSION_BLOCK
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_SIGNED_HUMAN_POLICY
