# Node v2058 explanation: code walkthrough quality type contract

Defined the typed profile, scan, document evaluation, bucket, and message contracts for the documentation quality gate.
