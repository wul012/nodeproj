# Node v1240 signed approval artifact draft text package review preflight

## What changed

Node v1240 contributes to the v1237-v1261 review preflight by covering the correlation handle slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The identity slice preserves correlation reviewability across archive records without enabling runtime routing.
