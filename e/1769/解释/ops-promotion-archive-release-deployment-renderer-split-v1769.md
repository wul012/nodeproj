# Node v1769 - ops promotion archive release deployment renderer split

## Focus

Extract the deployment execution record verification renderer into the execution/receipt module.
