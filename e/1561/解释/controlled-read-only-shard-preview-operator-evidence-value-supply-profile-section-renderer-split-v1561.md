# v1561 operator evidence value supply profile section renderer split

v1561 moves operator evidence import preflight and operator evidence value draft rendering into an import renderer.
