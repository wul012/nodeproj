# v1547 operator evidence value supply approval profile section renderer split

v1547 records the signed approval capture profile section renderer in the type module catalog.
