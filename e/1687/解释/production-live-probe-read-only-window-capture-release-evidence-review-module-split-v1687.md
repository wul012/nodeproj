# Node v1687 - production live probe read-only window capture release evidence review module split

## Focus

Extract the release evidence review profile, field-guide, and message contracts.
