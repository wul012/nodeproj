# Node v1690 - production live probe read-only window capture release evidence review module split

## Focus

Move Java v51 field guide reference constants into the builder module.
