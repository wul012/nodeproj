# Node v1736 - controlled read-only shard preview type module catalog entry group split

## Focus

Lock the entry group id order to the intended maintenance boundaries.
