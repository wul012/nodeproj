# Node v1294 signed approval artifact draft text package comparison preflight

## What changed

Node v1294 contributes to the v1287-v1311 comparison preflight by covering the digest slice: source digest. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The digest slice closes the digest family with a read-only source digest lane and acceptance control.
