# Node v989 controlled read-only shard preview operator evidence value supply approval packet review: approval timestamp review control

## What This Version Owns

v989 owns the approval timestamp review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_APPROVAL_TIMESTAMP in the approval-field group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_JAVA_VERSION_RANGE.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_JAVA_VERSION_RANGE
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_APPROVAL_TIMESTAMP
