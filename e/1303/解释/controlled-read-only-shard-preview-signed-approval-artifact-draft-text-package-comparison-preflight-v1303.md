# Node v1303 signed approval artifact draft text package comparison preflight

## What changed

Node v1303 contributes to the v1287-v1311 comparison preflight by covering the policy slice: policy assertion. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The policy slice turns policy readiness into a comparison lane and blocks acceptance until a later package comparison exists.
