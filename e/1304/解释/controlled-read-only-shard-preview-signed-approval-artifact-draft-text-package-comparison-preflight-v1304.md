# Node v1304 signed approval artifact draft text package comparison preflight

## What changed

Node v1304 contributes to the v1287-v1311 comparison preflight by covering the policy slice: reviewer separation. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The policy slice records reviewer-separation policy as a package acceptance requirement instead of an approval grant.
