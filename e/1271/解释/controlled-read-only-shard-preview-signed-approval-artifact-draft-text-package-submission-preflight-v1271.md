# Node v1271 signed approval artifact draft text package submission preflight

## What changed

Node v1271 contributes to the v1262-v1286 submission preflight by covering the signature slice: signature signer. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
