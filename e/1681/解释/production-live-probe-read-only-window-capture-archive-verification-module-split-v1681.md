# Node v1681 - production live probe read-only window capture archive verification module split

## Focus

Keep blocked capture archive verification behavior covered after the split.
