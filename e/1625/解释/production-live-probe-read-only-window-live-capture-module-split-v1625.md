# Node v1625 - production live probe read-only window live capture module split
...
The original live capture module is reduced to orchestration and profile assembly.
