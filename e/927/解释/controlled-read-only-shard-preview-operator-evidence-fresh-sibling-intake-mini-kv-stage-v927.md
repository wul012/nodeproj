# Node v927 controlled read-only shard preview operator evidence fresh sibling intake: mini-kv release stage

## What This Version Owns

v927 contributes mini-kv release stage to the Node v912-v936 fresh sibling intake package. The slice is owned by mini-kv evidence consumption, but the implementation lives only in Node and reads committed sibling files through historical fallback-aware evidence helpers.

Detail: matches route-preview-import-preflight-release-package for the v560 release package stage.
