# Node v1613 - production live probe read-only window live capture module split

## Focus

production pass candidate gate.

## What changed

The pass-candidate flag remains gated by read-only readiness, open probes, and all captured records being pass.
