# Node v1149 signed approval artifact draft review package preflight explanation

Node v1149 adds the source evidence version package slot for the controlled read-only shard preview signed approval chain.

## What changed

- Package slot: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_REVIEW_PACKAGE_PREFLIGHT_SOURCE_VERSION_SLOT
- Package guard: ARTIFACT_DRAFT_REVIEW_PACKAGE_PREFLIGHT_SOURCE_VERSION_GUARD
- Purpose: exposes the source evidence version that later draft text must cite.
