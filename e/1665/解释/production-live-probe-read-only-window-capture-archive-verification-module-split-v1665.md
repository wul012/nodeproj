# Node v1665 - production live probe read-only window capture archive verification module split

## Focus

Keep ready-for-read-only-capture-archive-verification evaluation inside the builder.
