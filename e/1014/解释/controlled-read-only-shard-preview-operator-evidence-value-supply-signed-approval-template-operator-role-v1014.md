# Node v1014 controlled read-only shard preview operator evidence value supply signed approval template: operator role field

## What This Version Owns

v1014 owns the operator role field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_OPERATOR_ROLE, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_OPERATOR_IDENTITY, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_OPERATOR_ROLE_REQUIRED.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_OPERATOR_IDENTITY
- Template field: SIGNED_APPROVAL_TEMPLATE_OPERATOR_ROLE
- Template clause: SIGNED_APPROVAL_TEMPLATE_OPERATOR_ROLE_REQUIRED
- Group: identity
