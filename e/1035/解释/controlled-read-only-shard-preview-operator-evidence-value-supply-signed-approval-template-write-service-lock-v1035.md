# Node v1035 controlled read-only shard preview operator evidence value supply signed approval template: write and service lock field

## What This Version Owns

v1035 owns the write and service lock field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_WRITE_SERVICE_LOCK, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_WRITE_AND_SERVICE_BLOCK, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_WRITE_SERVICE_LOCK.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_WRITE_AND_SERVICE_BLOCK
- Template field: SIGNED_APPROVAL_TEMPLATE_WRITE_SERVICE_LOCK
- Template clause: SIGNED_APPROVAL_TEMPLATE_WRITE_SERVICE_LOCK
