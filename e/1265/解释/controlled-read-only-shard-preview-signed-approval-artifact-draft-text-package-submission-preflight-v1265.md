# Node v1265 signed approval artifact draft text package submission preflight

## What changed

Node v1265 contributes to the v1262-v1286 submission preflight by covering the identity slice: approval intent. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The identity slice records the approval-intent submission slot and blocks comparison until a matching manual package artifact exists.
