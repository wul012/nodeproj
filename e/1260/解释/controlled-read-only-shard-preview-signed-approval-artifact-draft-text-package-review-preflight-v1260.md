# Node v1260 signed approval artifact draft text package review preflight

## What changed

Node v1260 contributes to the v1237-v1261 review preflight by covering the sibling non-mutation lock slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The execution lock slice keeps Java and mini-kv state immutable during review preflight.
