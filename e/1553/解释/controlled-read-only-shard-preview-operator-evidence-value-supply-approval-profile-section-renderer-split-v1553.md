# v1553 operator evidence value supply approval profile section renderer split

v1553 documents that Java and mini-kv can continue in parallel without fresh evidence for this renderer split.
