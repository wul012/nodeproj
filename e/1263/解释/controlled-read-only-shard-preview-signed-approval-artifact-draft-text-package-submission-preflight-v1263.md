# Node v1263 signed approval artifact draft text package submission preflight

## What changed

Node v1263 contributes to the v1262-v1286 submission preflight by covering the identity slice: operator identity. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The identity slice binds the operator identity review criterion to a manual package submission slot while keeping approval capture and execution disabled.
