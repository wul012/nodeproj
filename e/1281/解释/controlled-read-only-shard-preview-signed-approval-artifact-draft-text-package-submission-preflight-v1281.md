# Node v1281 signed approval artifact draft text package submission preflight

## What changed

Node v1281 contributes to the v1262-v1286 submission preflight by covering the execution lock slice: no runtime payload. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The execution lock slice adds the runtime-payload blocker to the submission comparison surface.
