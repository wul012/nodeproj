# Node v1266 signed approval artifact draft text package submission preflight

## What changed

Node v1266 contributes to the v1262-v1286 submission preflight by covering the digest slice: package digest. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The digest slice adds the first digest comparison pin so manual package material can later be compared without changing sibling state.
