# Node v1256 signed approval artifact draft text package review preflight

## What changed

Node v1256 contributes to the v1237-v1261 review preflight by covering the no runtime payload lock slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The execution lock slice keeps runtime payload import blocked throughout review preflight.
