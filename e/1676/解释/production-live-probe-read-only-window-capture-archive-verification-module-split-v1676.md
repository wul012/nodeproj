# Node v1676 - production live probe read-only window capture archive verification module split

## Focus

Extract capture archive verification Markdown rendering into a dedicated renderer module.
