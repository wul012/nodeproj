# Node v1251 signed approval artifact draft text package review preflight

## What changed

Node v1251 contributes to the v1237-v1261 review preflight by covering the operator value handle slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The value binding slice keeps operator value references as handles only and blocks credential value reads.
