# Node v1274 signed approval artifact draft text package submission preflight

## What changed

Node v1274 contributes to the v1262-v1286 submission preflight by covering the source slice: mini-kv evidence handle. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The source slice maps mini-kv source evidence to a submission slot while documenting that no mini-kv service start is required.
