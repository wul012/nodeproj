# Node v1181 signed approval artifact draft authoring readiness explanation

Node v1181 adds the raw secret embargo authoring requirement for the controlled read-only shard preview signed approval chain.

## What changed

- Authoring requirement: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_RAW_SECRET_EMBARGO
- Authoring blocker: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_RAW_SECRET_EMBARGO_BLOCKER
- Category: execution lock
- Source binding: raw secret embargo package slot and guard from Node v1161 review package preflight.
- Purpose: proves the authoring readiness surface carries no raw secret value.
