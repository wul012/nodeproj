# Node v1301 signed approval artifact draft text package comparison preflight

## What changed

Node v1301 contributes to the v1287-v1311 comparison preflight by covering the value slice: operator value handle. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The value slice binds operator value evidence to an offline comparison lane and leaves readyForOperatorValueSupply=false.
