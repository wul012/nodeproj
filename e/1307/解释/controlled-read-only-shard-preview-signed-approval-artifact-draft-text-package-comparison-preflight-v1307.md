# Node v1307 signed approval artifact draft text package comparison preflight

## What changed

Node v1307 contributes to the v1287-v1311 comparison preflight by covering the execution lock slice: no live execution. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The execution lock slice keeps live execution locked even when every comparison lane is ready.
