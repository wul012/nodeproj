# Node v1664 - production live probe read-only window capture archive verification module split

## Focus

Move capture archive verification check assembly into the builder.
