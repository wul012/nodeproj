# Node v1276 signed approval artifact draft text package submission preflight

## What changed

Node v1276 contributes to the v1262-v1286 submission preflight by covering the value slice: operator value handle. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The value slice binds operator value evidence to a manual package slot and leaves readyForOperatorValueSupply=false.
