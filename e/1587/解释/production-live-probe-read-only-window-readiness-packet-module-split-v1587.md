# Node v1587 - production live probe read-only window readiness packet module split

## Focus

manual review steps extraction.

## What changed

The five manual review steps moved into the builder module so review workflow text is no longer mixed with route loading.
