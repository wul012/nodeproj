# Node v1701 - production live probe read-only window capture release evidence review module split

## Focus

Keep upstream-actions and automatic-start safety checks inside the builder.
