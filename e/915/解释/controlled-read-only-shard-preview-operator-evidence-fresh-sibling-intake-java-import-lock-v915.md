# Node v915 controlled read-only shard preview operator evidence fresh sibling intake: Java import lock

## What This Version Owns

v915 contributes Java import lock to the Node v912-v936 fresh sibling intake package. The slice is owned by Java evidence consumption, but the implementation lives only in Node and reads committed sibling files through historical fallback-aware evidence helpers.

Detail: matches the Java closeout check proving operator evidence import remains locked.
