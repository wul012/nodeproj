# Node v1757 - ops promotion archive release deployment renderer split

## Focus

Define the renderer split boundary for promotion release, deployment, and audit Markdown.
