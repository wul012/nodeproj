# Node v1241 signed approval artifact draft text package review preflight

## What changed

Node v1241 contributes to the v1237-v1261 review preflight by covering the template digest slice. It turns the corresponding v1236 text package intake field into an offline review criterion and pairs it with a rejection control for unreviewable package material.
...
The digest slice pins the source template digest for later offline comparison.
