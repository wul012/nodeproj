...
v947 contributes Java ready test to the Node v937-v961 value supply envelope package. It requires Java route evidence to assert value draft readiness true.
