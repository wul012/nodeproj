# Node v1295 signed approval artifact draft text package comparison preflight

## What changed

Node v1295 contributes to the v1287-v1311 comparison preflight by covering the signature slice: signature envelope. It turns the corresponding v1286 submission slot into an offline comparison lane and pairs it with an acceptance control for uncompared or unacceptable package material.
...
The signature slice prepares detached signature envelope evidence as a comparison lane without parsing or validating a real signature payload.
