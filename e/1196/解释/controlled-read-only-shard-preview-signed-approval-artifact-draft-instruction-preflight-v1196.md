# Node v1196 signed approval artifact draft instruction preflight explanation

Node v1196 adds the detached signature instruction slot for the controlled read-only shard preview signed approval chain.

## What changed

- Instruction slot: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_DETACHED_SIGNATURE_SLOT
- Instruction guard: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_DETACHED_SIGNATURE_SLOT_GUARD
- Category: signature envelope
- Source binding: detached signature authoring requirement and blocker from Node v1186 authoring readiness.
- Purpose: prepares an instruction slot that keeps detached signature handling out of band.
