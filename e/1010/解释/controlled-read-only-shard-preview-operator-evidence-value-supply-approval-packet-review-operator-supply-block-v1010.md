# Node v1010 controlled read-only shard preview operator evidence value supply approval packet review: operator value supply block review control

## What This Version Owns

v1010 owns the operator value supply block review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_OPERATOR_SUPPLY_BLOCK in the execution-lock group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_STORE_UNCHANGED_TEST.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_STORE_UNCHANGED_TEST
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_OPERATOR_SUPPLY_BLOCK
