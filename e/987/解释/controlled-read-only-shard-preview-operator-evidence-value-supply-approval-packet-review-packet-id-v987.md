# Node v987 controlled read-only shard preview operator evidence value supply approval packet review: approval packet id review control

## What This Version Owns

v987 owns the approval packet id review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_PACKET_ID in the approval-field group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_JAVA_CLOSEOUT_PROFILE.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_JAVA_CLOSEOUT_PROFILE
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_PACKET_ID
