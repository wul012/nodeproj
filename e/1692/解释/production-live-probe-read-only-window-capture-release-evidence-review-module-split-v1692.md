# Node v1692 - production live probe read-only window capture release evidence review module split

## Focus

Move release evidence review endpoint constants into the builder module.
