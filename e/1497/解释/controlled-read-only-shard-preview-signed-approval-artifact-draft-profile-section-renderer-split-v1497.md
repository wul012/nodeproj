# v1497 signed approval artifact draft profile section renderer split

v1497 records the new signed approval artifact draft profile section renderer in the type module catalog.
