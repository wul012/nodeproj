# Node v1012 controlled read-only shard preview operator evidence value supply signed approval template: signed approval packet id field

## What This Version Owns

v1012 owns the signed approval packet id field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_PACKET_ID, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_PACKET_ID, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_PACKET_ID_REQUIRED.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_PACKET_ID
- Template field: SIGNED_APPROVAL_TEMPLATE_PACKET_ID
- Template clause: SIGNED_APPROVAL_TEMPLATE_PACKET_ID_REQUIRED
- Group: identity
