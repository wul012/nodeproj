# Node v1600 - production live probe read-only window readiness packet module split
...
The split uses type-only imports for profile contracts, avoiding runtime coupling between loader, builder, types, and renderer.
