# v1537 operator evidence value supply approval profile section renderer split

v1537 moves signed approval capture preflight and capture artifact preflight rendering into a capture renderer.
