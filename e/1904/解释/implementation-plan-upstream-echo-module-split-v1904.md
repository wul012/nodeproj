# Node v1904 - implementation plan upstream echo module split
...
The legacy service entrypoint is now a compatibility barrel for the loader and renderer exports.
