# Node v1022 controlled read-only shard preview operator evidence value supply signed approval template: redacted value digest field

## What This Version Owns

v1022 owns the redacted value digest field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_REDACTED_DIGEST, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_REDACTED_DIGEST, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_REDACTED_DIGEST_REQUIRED.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_REDACTED_DIGEST
- Template field: SIGNED_APPROVAL_TEMPLATE_REDACTED_DIGEST
- Template clause: SIGNED_APPROVAL_TEMPLATE_REDACTED_DIGEST_REQUIRED
- Group: value-shape
