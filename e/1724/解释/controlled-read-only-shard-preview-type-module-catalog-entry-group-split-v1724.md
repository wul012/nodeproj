# Node v1724 - controlled read-only shard preview type module catalog entry group split

## Focus

Move foundation and live read-only window entries into a focused group module.
