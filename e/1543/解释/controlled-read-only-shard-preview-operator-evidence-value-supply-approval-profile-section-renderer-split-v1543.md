# v1543 operator evidence value supply approval profile section renderer split

v1543 locks approvalCaptured and signedApprovalPresent as false in the extracted approval output.
