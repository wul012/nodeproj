# Node v1624 - production live probe read-only window live capture module split
...
The split keeps profile contracts type-only and prevents avoidable runtime coupling.
