# Node v1171 signed approval artifact draft authoring readiness explanation

Node v1171 adds the detached signature authoring requirement for the controlled read-only shard preview signed approval chain.

## What changed

- Authoring requirement: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_DETACHED_SIGNATURE
- Authoring blocker: SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_DETACHED_SIGNATURE_BLOCKER
- Category: signature envelope
- Source binding: detached signature package slot and guard from Node v1161 review package preflight.
- Purpose: requires detached signature handling to remain external and absent from this readiness artifact.
