# Node v1004 controlled read-only shard preview operator evidence value supply approval packet review: source draft digest review control

## What This Version Owns

v1004 owns the source draft digest review control slice of the v987-v1011 approval packet review package. It adds review control VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_DIGEST_COVERAGE in the source-evidence group and maps it to source approval packet draft slot VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_ACCEPTED_ZERO.

## Source Draft Binding

- Source Node version: Node v986
- Source approval packet draft slot: VALUE_SUPPLY_APPROVAL_PACKET_MINI_KV_ACCEPTED_ZERO
- Review control code: VALUE_SUPPLY_APPROVAL_REVIEW_DRAFT_DIGEST_COVERAGE
