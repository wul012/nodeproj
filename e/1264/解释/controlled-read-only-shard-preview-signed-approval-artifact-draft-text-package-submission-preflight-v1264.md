# Node v1264 signed approval artifact draft text package submission preflight

## What changed

Node v1264 contributes to the v1262-v1286 submission preflight by covering the identity slice: correlation handle. It turns the corresponding v1261 review criterion into a manual submission slot and pairs it with a comparison control for unsubmitted or uncomparable package material.
...
The identity slice maps correlation evidence into a submission slot so later comparison can reject a package that cannot be tied to the prepared preview.
