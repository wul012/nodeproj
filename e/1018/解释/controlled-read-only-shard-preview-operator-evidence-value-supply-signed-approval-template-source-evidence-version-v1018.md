# Node v1018 controlled read-only shard preview operator evidence value supply signed approval template: source evidence version field

## What This Version Owns

v1018 owns the source evidence version field slice of the v1012-v1036 signed approval template preflight. It adds field SIGNED_APPROVAL_TEMPLATE_SOURCE_EVIDENCE_VERSION, binds it to source review control VALUE_SUPPLY_APPROVAL_REVIEW_SOURCE_EVIDENCE_VERSION, and pairs it with clause SIGNED_APPROVAL_TEMPLATE_SOURCE_VERSION_BOUND.

## Template Binding

- Source Node version: Node v1011
- Source review control: VALUE_SUPPLY_APPROVAL_REVIEW_SOURCE_EVIDENCE_VERSION
- Template field: SIGNED_APPROVAL_TEMPLATE_SOURCE_EVIDENCE_VERSION
- Template clause: SIGNED_APPROVAL_TEMPLATE_SOURCE_VERSION_BOUND
