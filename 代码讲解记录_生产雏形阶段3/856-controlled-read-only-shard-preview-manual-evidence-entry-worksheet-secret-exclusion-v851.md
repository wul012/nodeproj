# Node v851 code walkthrough: manual evidence entry worksheet secret exclusion

v851 contributes `ENTRY_WORKSHEET_SECRET_EXCLUSION` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_SECRET_EXCLUSION` from the v836 review package and records secret exclusion and keeps every slot free of secret values.
