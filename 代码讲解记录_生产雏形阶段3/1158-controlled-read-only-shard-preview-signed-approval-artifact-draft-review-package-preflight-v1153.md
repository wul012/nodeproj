# Code walkthrough 1158 - Node v1153 signed approval artifact draft review package preflight

## Slice

Node v1153 contributes value shape package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
