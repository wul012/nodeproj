# Node v894 code walkthrough: operator evidence value draft redaction rules

v894 contributes `VALUE_DRAFT_REDACTION_RULES` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_REDACTION_RULES` and adds redaction coverage draft counts without accepting actual values.
