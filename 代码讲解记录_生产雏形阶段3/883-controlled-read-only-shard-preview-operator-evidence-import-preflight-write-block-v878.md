# Node v878 code walkthrough: operator evidence import preflight write block

v878 contributes `IMPORT_PREFLIGHT_WRITE_BLOCK` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_WRITE_BLOCK` from the v861 worksheet and keeps write routing blocked in the import preflight.
