# Code walkthrough 1155 - Node v1150 signed approval artifact draft review package preflight

## Slice

Node v1150 contributes source evidence file package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
