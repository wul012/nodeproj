# Node v869 code walkthrough: operator evidence import preflight redaction rules

v869 contributes `IMPORT_PREFLIGHT_REDACTION_RULES` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_REDACTION_RULES` from the v861 worksheet and preserves redaction coverage and blocks secret-bearing values.
