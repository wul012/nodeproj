# 1284. Node v1279 signed approval artifact draft text package submission preflight walkthrough
...
Node v1279 focuses on the policy slice: records reviewer-separation policy as a package comparison requirement instead of an approval grant.
