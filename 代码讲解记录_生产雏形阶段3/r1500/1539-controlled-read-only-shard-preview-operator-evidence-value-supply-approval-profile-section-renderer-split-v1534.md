# v1534 code walkthrough

v1534 main renderer delegation: lets the main live-window renderer keep route orchestration while local renderers own the approval group.
