# v1508 code walkthrough

v1508 text package boundary selection: identifies the nine text package route sections that still lived in the main live-window renderer.
