# v1509 code walkthrough

v1509 main renderer delegation: lets the main live-window renderer keep ordering orchestration while the text package renderer owns the section group.
