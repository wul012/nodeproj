# Node v918 code walkthrough: operator evidence fresh sibling intake Java manual entry block

v918 contributes Java manual entry block to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v918
- Slot title: Java manual entry block
- Project evidence consumed: Java
- Purpose: freezes readyForManualEvidenceEntry so manual value entry remains out of scope.
