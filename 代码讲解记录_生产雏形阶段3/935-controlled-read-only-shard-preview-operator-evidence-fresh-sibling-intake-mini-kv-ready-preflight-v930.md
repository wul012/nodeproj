# Node v930 code walkthrough: operator evidence fresh sibling intake mini-kv preflight readiness

v930 contributes mini-kv preflight readiness to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v930
- Slot title: mini-kv preflight readiness
- Project evidence consumed: mini-kv
- Purpose: matches readyForOperatorEvidenceImportPreflight:true as a source-readiness signal only.
