# 1298. Node v1293 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1293 focuses on the digest slice: keeps the v1236 intake digest reachable from the comparison preflight and marks it as a digest recheck lane.
