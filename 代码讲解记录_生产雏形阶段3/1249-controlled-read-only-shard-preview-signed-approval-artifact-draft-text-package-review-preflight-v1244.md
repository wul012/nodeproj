# 1249. Node v1244 signed approval artifact draft text package review preflight walkthrough
...
Node v1244 focuses on draft package digest: requires the later package digest to remain lowercase sha256 and independently reviewable.
