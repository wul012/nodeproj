# Node v892 code walkthrough: operator evidence value draft required fields

v892 contributes `VALUE_DRAFT_REQUIRED_FIELDS` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_REQUIRED_FIELDS` and adds required field completion draft counts without accepting actual values.
