# 1272. Node v1267 signed approval artifact draft text package submission preflight walkthrough
...
Node v1267 focuses on the digest slice: carries the review digest binding from v1261 into a submission slot and keeps submitted package counts at zero.
