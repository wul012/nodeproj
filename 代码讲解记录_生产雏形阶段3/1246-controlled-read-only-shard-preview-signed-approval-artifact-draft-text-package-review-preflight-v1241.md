# 1246. Node v1241 signed approval artifact draft text package review preflight walkthrough
...
Node v1241 focuses on template digest: pins the source template digest for later offline comparison.
