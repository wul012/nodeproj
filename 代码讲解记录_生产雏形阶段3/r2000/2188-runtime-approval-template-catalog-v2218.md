...
最终 Node Evidence run `29794003784` 在 head `f5fa295a` 上通过，Linux runner 覆盖 578 个文件、
1,758 项测试，测试阶段 795.89 秒，随后 build、health、metrics、release readiness smoke 和 server
cleanup 全绿。由此本地等价 oracle、Windows 全量、独立 discovery 与 Linux CI 形成闭环。
