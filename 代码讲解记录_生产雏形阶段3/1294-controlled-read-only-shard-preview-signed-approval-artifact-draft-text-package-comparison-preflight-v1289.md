# 1294. Node v1289 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1289 focuses on the identity slice: maps correlation evidence into a comparison lane so later acceptance can reject a package that cannot be tied to the prepared preview.
