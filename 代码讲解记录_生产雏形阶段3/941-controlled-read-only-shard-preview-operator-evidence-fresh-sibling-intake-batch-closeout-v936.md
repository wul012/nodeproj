# Node v936 code walkthrough: operator evidence fresh sibling intake batch closeout

v936 contributes batch closeout to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v936
- Slot title: batch closeout
- Project evidence consumed: Node
- Purpose: closes the Node v912-v936 intake by tying Java v608, mini-kv v560, and Node v911 value draft evidence together.
