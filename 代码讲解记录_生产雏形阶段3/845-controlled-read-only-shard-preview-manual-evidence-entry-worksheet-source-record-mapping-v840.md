# Node v840 code walkthrough: manual evidence entry worksheet source record mapping

v840 contributes `ENTRY_WORKSHEET_SOURCE_RECORD_MAPPING` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_SOURCE_RECORD_MAPPING` from the v836 review package and records mapped control count and missing mapping count before future entered evidence is accepted.
