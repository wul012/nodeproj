# Node v874 code walkthrough: operator evidence import preflight cleanup coverage

v874 contributes `IMPORT_PREFLIGHT_CLEANUP_COVERAGE` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_CLEANUP_COVERAGE` from the v861 worksheet and preserves cleanup coverage as an import preflight blocker.
