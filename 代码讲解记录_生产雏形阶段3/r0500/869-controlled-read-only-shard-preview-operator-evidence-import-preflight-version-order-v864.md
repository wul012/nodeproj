# Node v864 code walkthrough: operator evidence import preflight version order

v864 contributes `IMPORT_PREFLIGHT_VERSION_ORDER` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_VERSION_ORDER` from the v861 worksheet and defines canonical version label normalization for the import preflight.
