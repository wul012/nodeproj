# Node v927 code walkthrough: operator evidence fresh sibling intake mini-kv release stage

v927 contributes mini-kv release stage to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v927
- Slot title: mini-kv release stage
- Project evidence consumed: mini-kv
- Purpose: matches route-preview-import-preflight-release-package for the v560 release package stage.
