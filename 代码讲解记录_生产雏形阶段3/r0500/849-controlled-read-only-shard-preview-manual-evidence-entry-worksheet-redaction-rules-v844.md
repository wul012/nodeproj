# Node v844 code walkthrough: manual evidence entry worksheet redaction rules

v844 contributes `ENTRY_WORKSHEET_REDACTION_RULES` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_REDACTION_RULES_PRESERVED` from the v836 review package and records redaction rule coverage and keeps secret values out of the worksheet.
