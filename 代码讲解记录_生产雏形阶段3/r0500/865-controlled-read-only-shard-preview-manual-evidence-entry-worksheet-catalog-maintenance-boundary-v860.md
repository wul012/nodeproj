# Node v860 code walkthrough: manual evidence entry worksheet catalog maintenance boundary

v860 contributes `ENTRY_WORKSHEET_CATALOG_MAINTENANCE_BOUNDARY` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_RENDERER_MAINTENANCE_BOUNDARY` from the v836 review package and records renderer split and catalog builder maintenance confirmation.
