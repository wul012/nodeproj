# Node v843 code walkthrough: manual evidence entry worksheet acceptance criteria

v843 contributes `ENTRY_WORKSHEET_ACCEPTANCE_CRITERIA` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_ACCEPTANCE_CRITERIA_PRESERVED` from the v836 review package and records acceptance criterion count and missing criterion count for later operator review.
