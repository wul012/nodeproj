# Node v928 code walkthrough: operator evidence fresh sibling intake mini-kv slot count

v928 contributes mini-kv slot count to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v928
- Slot title: mini-kv slot count
- Project evidence consumed: mini-kv
- Purpose: matches operatorPreflightSlotCount:25 so Node sees a complete upstream slot package.
