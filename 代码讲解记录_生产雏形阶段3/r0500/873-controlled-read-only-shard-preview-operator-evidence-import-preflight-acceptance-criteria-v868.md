# Node v868 code walkthrough: operator evidence import preflight acceptance criteria

v868 contributes `IMPORT_PREFLIGHT_ACCEPTANCE_CRITERIA` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_ACCEPTANCE_CRITERIA` from the v861 worksheet and preserves acceptance criterion coverage for a later value importer.
