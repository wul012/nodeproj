# Node v850 code walkthrough: manual evidence entry worksheet failure class coverage

v850 contributes `ENTRY_WORKSHEET_FAILURE_CLASS_COVERAGE` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_FAILURE_CLASS_COVERAGE` from the v836 review package and records failure class coverage without turning triage into execution.
