# Node v839 code walkthrough: manual evidence entry worksheet version order

v839 contributes `ENTRY_WORKSHEET_VERSION_ORDER` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_VERSION_ORDER` from the v836 review package and records first version, last version, and version order status for the v812-v836 review controls.
