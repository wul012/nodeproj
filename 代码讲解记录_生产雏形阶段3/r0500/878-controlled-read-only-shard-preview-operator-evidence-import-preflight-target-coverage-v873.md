# Node v873 code walkthrough: operator evidence import preflight target coverage

v873 contributes `IMPORT_PREFLIGHT_TARGET_COVERAGE` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_TARGET_COVERAGE` from the v861 worksheet and preserves Node, Java, mini-kv, and policy/archive target coverage.
