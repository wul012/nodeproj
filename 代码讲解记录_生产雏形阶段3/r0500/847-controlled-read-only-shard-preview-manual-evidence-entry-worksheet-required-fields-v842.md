# Node v842 code walkthrough: manual evidence entry worksheet required fields

v842 contributes `ENTRY_WORKSHEET_REQUIRED_FIELDS` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_REQUIRED_FIELDS_PRESERVED` from the v836 review package and records required field count and missing field count while keeping values blank.
