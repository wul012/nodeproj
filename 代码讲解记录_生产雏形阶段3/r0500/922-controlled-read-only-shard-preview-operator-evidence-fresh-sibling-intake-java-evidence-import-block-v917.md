# Node v917 code walkthrough: operator evidence fresh sibling intake Java evidence import block

v917 contributes Java evidence import block to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v917
- Slot title: Java evidence import block
- Project evidence consumed: Java
- Purpose: freezes readyForEvidenceImport so Node can assert the value import path is still false.
