# Code walkthrough 978: Node v973 approval packet draft Java execution locks test

## Version Position

This walkthrough covers Node v973 in the v962-v986 approval packet draft batch. The slice consumes java-v658-value-supply-assurance-test / java-value-supply-test-execution-locks-held and maps it from source envelope slot VALUE_SUPPLY_ENVELOPE_JAVA_IMPORT_FALSE_TEST.
