# Node v885 code walkthrough: operator evidence import preflight catalog maintenance boundary

v885 contributes `IMPORT_PREFLIGHT_CATALOG_MAINTENANCE_BOUNDARY` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_CATALOG_MAINTENANCE_BOUNDARY` from the v861 worksheet and records the slot-builder split as the maintenance boundary for this package.
