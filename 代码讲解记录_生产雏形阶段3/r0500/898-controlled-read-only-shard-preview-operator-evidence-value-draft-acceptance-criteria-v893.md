# Node v893 code walkthrough: operator evidence value draft acceptance criteria

v893 contributes `VALUE_DRAFT_ACCEPTANCE_CRITERIA` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_ACCEPTANCE_CRITERIA` and adds acceptance criterion draft statuses without accepting actual values.
