# Node v925 code walkthrough: operator evidence fresh sibling intake mini-kv command

v925 contributes mini-kv command to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v925
- Slot title: mini-kv command
- Project evidence consumed: mini-kv
- Purpose: matches SHARDROUTEIMPORTPREFLIGHTJSON as a read-only command surface.
