# Node v861 code walkthrough: manual evidence entry worksheet closeout

v861 contributes `ENTRY_WORKSHEET_CLOSEOUT` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_PACKAGE_CLOSEOUT` from the v836 review package and closes the v837-v861 blank worksheet package and records the cross-project parallel plan.
