# Node v881 code walkthrough: operator evidence import preflight Node target

v881 contributes `IMPORT_PREFLIGHT_NODE_TARGET` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_NODE_TARGET` from the v861 worksheet and defines Node target status normalization without raw payload import.
