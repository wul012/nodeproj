# Node v931 code walkthrough: operator evidence fresh sibling intake mini-kv evidence import false

v931 contributes mini-kv evidence import false to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v931
- Slot title: mini-kv evidence import false
- Project evidence consumed: mini-kv
- Purpose: matches readyForEvidenceImport:false to keep importing blocked.
