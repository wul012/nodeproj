# Node v865 code walkthrough: operator evidence import preflight source record mapping

v865 contributes `IMPORT_PREFLIGHT_SOURCE_RECORD_MAPPING` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_SOURCE_RECORD_MAPPING` from the v861 worksheet and defines mapping count normalization and missing-mapping rejection.
