# Node v837 code walkthrough: manual evidence entry worksheet source packet ready

v837 contributes `ENTRY_WORKSHEET_SOURCE_PACKET_READY` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_SOURCE_PACKET_READY` from the v836 review package and records the reviewed source packet readiness flag and digest as a blank operator entry slot.
