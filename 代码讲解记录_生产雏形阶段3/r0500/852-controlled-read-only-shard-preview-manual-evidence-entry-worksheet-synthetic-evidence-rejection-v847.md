# Node v847 code walkthrough: manual evidence entry worksheet synthetic evidence rejection

v847 contributes `ENTRY_WORKSHEET_SYNTHETIC_EVIDENCE_REJECTION` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_SYNTHETIC_EVIDENCE_REJECTION` from the v836 review package and records that synthetic evidence is not accepted by this blank worksheet package.
