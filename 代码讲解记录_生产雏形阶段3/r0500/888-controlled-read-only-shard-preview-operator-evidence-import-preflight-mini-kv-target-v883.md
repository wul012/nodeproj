# Node v883 code walkthrough: operator evidence import preflight mini-kv target

v883 contributes `IMPORT_PREFLIGHT_MINI_KV_TARGET` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_MINI_KV_TARGET` from the v861 worksheet and defines mini-kv SHARDJSON status normalization and command guard.
