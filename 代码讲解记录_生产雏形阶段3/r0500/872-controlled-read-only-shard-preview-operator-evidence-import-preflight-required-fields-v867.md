# Node v867 code walkthrough: operator evidence import preflight required fields

v867 contributes `IMPORT_PREFLIGHT_REQUIRED_FIELDS` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_REQUIRED_FIELDS` from the v861 worksheet and preserves required field coverage before import can be considered.
