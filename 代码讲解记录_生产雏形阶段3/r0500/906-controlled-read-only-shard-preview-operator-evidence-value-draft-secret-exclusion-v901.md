# Node v901 code walkthrough: operator evidence value draft secret exclusion

v901 contributes `VALUE_DRAFT_SECRET_EXCLUSION` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_SECRET_EXCLUSION` and adds secret exclusion draft confirmations without accepting actual values.
