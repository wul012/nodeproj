# Node v887 code walkthrough: operator evidence value draft source packet ready

v887 contributes `VALUE_DRAFT_SOURCE_PACKET_READY` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_SOURCE_PACKET_READY` and adds source packet readiness draft fields without accepting actual values.
