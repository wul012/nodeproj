# Node v911 code walkthrough: operator evidence value draft closeout

v911 contributes `VALUE_DRAFT_CLOSEOUT` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_CLOSEOUT` and adds package closeout draft confirmations without accepting actual values.
