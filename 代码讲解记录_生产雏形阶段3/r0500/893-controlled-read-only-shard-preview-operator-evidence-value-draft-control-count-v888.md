# Node v888 code walkthrough: operator evidence value draft control count

v888 contributes `VALUE_DRAFT_CONTROL_COUNT` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_CONTROL_COUNT` and adds integer control count draft fields without accepting actual values.
