# Code walkthrough 968: Node v963 approval packet draft Java closeout version

## Version Position

This walkthrough covers Node v963 in the v962-v986 approval packet draft batch. The slice consumes java-v658-value-supply-closeout-service / java-value-supply-closeout-version and maps it from source envelope slot VALUE_SUPPLY_ENVELOPE_JAVA_RESPONSE_VERSION.
