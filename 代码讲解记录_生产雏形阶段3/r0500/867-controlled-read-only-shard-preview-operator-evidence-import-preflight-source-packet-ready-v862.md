# Node v862 code walkthrough: operator evidence import preflight source packet ready

v862 contributes `IMPORT_PREFLIGHT_SOURCE_PACKET_READY` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_SOURCE_PACKET_READY` from the v861 worksheet and defines source packet readiness import normalization without importing a value.
