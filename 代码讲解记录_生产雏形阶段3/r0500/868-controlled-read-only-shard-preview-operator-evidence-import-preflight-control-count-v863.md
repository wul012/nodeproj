# Node v863 code walkthrough: operator evidence import preflight control count

v863 contributes `IMPORT_PREFLIGHT_CONTROL_COUNT` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_CONTROL_COUNT` from the v861 worksheet and defines count normalization and mismatch rejection before any operator value is accepted.
