# Node v924 code walkthrough: operator evidence fresh sibling intake mini-kv contract

v924 contributes mini-kv contract to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v924
- Slot title: mini-kv contract
- Project evidence consumed: mini-kv
- Purpose: matches the C++ import preflight contract string for shard-route-preview-operator-import-preflight.v1.
