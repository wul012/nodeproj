# Node v879 code walkthrough: operator evidence import preflight service start block

v879 contributes `IMPORT_PREFLIGHT_SERVICE_START_BLOCK` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_SERVICE_START_BLOCK` from the v861 worksheet and keeps service startup blocked for Node, Java, and mini-kv.
