# Node v871 code walkthrough: operator evidence import preflight runtime payload exclusion

v871 contributes `IMPORT_PREFLIGHT_RUNTIME_PAYLOAD_EXCLUSION` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_RUNTIME_PAYLOAD_EXCLUSION` from the v861 worksheet and blocks runtime payload import at the preflight boundary.
