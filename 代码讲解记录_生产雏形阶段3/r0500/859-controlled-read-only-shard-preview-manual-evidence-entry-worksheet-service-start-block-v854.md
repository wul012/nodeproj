# Node v854 code walkthrough: manual evidence entry worksheet service start block

v854 contributes `ENTRY_WORKSHEET_SERVICE_START_BLOCK` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_SERVICE_START_BLOCK` from the v836 review package and records service-start absence and prevents Node from starting Java or mini-kv.
