# Node v910 code walkthrough: operator evidence value draft catalog maintenance boundary

v910 contributes `VALUE_DRAFT_CATALOG_MAINTENANCE_BOUNDARY` to the operator evidence value draft package. It maps back to `IMPORT_PREFLIGHT_CATALOG_MAINTENANCE_BOUNDARY` and adds catalog maintenance draft confirmations without accepting actual values.
