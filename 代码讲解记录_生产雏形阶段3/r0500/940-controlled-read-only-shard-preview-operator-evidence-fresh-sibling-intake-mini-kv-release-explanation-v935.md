# Node v935 code walkthrough: operator evidence fresh sibling intake mini-kv release explanation

v935 contributes mini-kv release explanation to the fresh sibling intake chain. It is part of the v912-v936 package that follows Node v911 value draft and consumes committed Java v608 plus mini-kv v560 read-only evidence.
...
- Version: Node v935
- Slot title: mini-kv release explanation
- Project evidence consumed: mini-kv
- Purpose: matches the v560 explanation for release-package archive evidence and stopped TCP smoke.
