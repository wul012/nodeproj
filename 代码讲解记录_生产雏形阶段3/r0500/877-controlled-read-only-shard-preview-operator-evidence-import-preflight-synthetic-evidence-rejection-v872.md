# Node v872 code walkthrough: operator evidence import preflight synthetic evidence rejection

v872 contributes `IMPORT_PREFLIGHT_SYNTHETIC_EVIDENCE_REJECTION` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_SYNTHETIC_EVIDENCE_REJECTION` from the v861 worksheet and blocks synthetic evidence acceptance before importer implementation.
