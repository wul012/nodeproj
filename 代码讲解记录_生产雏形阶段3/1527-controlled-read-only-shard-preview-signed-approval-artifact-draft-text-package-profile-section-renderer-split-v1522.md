# v1522 code walkthrough

v1522 fail-closed state preservation: focused coverage checks `signedApprovalPresent`, `importsRuntimePayload`, and `containsSecretValue` remain false.
