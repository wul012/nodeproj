# 1276. Node v1271 signed approval artifact draft text package submission preflight walkthrough
...
Node v1271 focuses on the signature slice: separates signer identity comparison from package acceptance and keeps approvalCaptured=false.
