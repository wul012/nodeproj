# Node v859 code walkthrough: manual evidence entry worksheet policy/archive targets

v859 contributes `ENTRY_WORKSHEET_POLICY_ARCHIVE_TARGETS` to the blank manual evidence entry worksheet. It maps back to `INTAKE_REVIEW_POLICY_ARCHIVE_TARGETS` from the v836 review package and adds policy and archive evidence status fields without importing runtime payload.
