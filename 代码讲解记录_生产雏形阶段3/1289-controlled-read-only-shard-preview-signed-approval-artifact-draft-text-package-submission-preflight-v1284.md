# 1289. Node v1284 signed approval artifact draft text package submission preflight walkthrough
...
Node v1284 focuses on the execution lock slice: records writeRoutingAllowed=false and blocks any write path from a manually submitted package.
