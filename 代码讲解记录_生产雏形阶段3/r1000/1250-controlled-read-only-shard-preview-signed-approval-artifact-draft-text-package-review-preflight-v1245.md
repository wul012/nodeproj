# 1250. Node v1245 signed approval artifact draft text package review preflight walkthrough
...
Node v1245 focuses on detached signature envelope: checks detached signature envelope metadata while blocking raw signature payload parsing.
