# Code walkthrough: Node v1102 signed approval capture artifact draft preflight redacted value digest draft field
...
Node v1102 contributes redacted value digest draft field. The code keeps readyForSignedApprovalArtifactDraft=false, readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Field: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_PREFLIGHT_REDACTED_VALUE_DIGEST`.
- Guard: `ARTIFACT_DRAFT_PREFLIGHT_REDACTED_VALUE_DIGEST_GUARD`.
- Source artifact fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_REDACTED_VALUE_DIGEST`.
- Required artifact fragment: `redactedValueDigest`.
- Blocker: `ARTIFACT_DRAFT_PREFLIGHT_REDACTED_VALUE_DIGEST_MISSING`.
