# 1269. Node v1264 signed approval artifact draft text package submission preflight walkthrough
...
Node v1264 focuses on the identity slice: maps correlation evidence into a submission slot so later comparison can reject a package that cannot be tied to the prepared preview.
