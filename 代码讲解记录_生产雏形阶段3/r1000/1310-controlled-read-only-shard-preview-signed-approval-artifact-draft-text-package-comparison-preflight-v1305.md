# 1310. Node v1305 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1305 focuses on the policy slice: carries review-state readiness forward while keeping submitted/compared/accepted/rejected package counts at zero.
