# Code walkthrough 1159 - Node v1154 signed approval artifact draft review package preflight

## Slice

Node v1154 contributes redaction policy package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
