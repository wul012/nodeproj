# 1242. Node v1237 signed approval artifact draft text package review preflight walkthrough
...
Node v1237 focuses on request manifest: binds the request manifest and operator intent to the v1236 expected field without accepting any submitted package text.
