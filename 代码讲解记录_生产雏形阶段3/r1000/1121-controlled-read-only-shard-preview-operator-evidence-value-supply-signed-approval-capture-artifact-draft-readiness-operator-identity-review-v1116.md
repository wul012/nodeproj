# Code walkthrough 1121: Node v1116 operator identity review lane

This walkthrough explains how Node v1116 participates in the signed approval artifact draft readiness package. The implementation is intentionally split so the long governance chain stays maintainable instead of turning the profile service into one giant file.
...
- v1116 lane: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_READINESS_OPERATOR_IDENTITY_REVIEW`.
- Source field checked by builder: `operatorIdentity`.
- Blocker emitted by control catalog: `REJECT_DRAFT_READINESS_OPERATOR_IDENTITY_UNREVIEWED`.
