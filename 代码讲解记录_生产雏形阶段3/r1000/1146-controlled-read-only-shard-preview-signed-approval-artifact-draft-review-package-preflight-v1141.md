# Code walkthrough 1146 - Node v1141 signed approval artifact draft review package preflight

## Slice

Node v1141 contributes operator identity package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
