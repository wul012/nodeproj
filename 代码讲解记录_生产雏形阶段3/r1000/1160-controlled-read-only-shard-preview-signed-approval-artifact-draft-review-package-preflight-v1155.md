# Code walkthrough 1160 - Node v1155 signed approval artifact draft review package preflight

## Slice

Node v1155 contributes provenance policy package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
