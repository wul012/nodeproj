# Code walkthrough 1145 - Node v1140 signed approval artifact draft review package preflight

## Slice

Node v1140 contributes approval review digest package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
