# Code walkthrough 1154 - Node v1149 signed approval artifact draft review package preflight

## Slice

Node v1149 contributes source evidence version package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
