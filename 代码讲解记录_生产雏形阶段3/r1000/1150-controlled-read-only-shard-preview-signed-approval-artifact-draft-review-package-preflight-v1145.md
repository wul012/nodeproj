# Code walkthrough 1150 - Node v1145 signed approval artifact draft review package preflight

## Slice

Node v1145 contributes signature algorithm package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
