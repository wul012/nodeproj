# 1252. Node v1247 signed approval artifact draft text package review preflight walkthrough
...
Node v1247 focuses on signature timestamp metadata: requires timestamp metadata to be reviewed out of band before any approval grant is considered.
