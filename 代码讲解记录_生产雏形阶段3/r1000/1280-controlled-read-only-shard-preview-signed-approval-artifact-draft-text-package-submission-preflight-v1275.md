# 1280. Node v1275 signed approval artifact draft text package submission preflight walkthrough
...
Node v1275 focuses on the source slice: keeps historical fixture fallback evidence visible for GitHub runner compatibility.
