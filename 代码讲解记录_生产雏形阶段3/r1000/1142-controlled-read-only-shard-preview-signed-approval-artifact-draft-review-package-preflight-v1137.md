# Code walkthrough 1142 - Node v1137 signed approval artifact draft review package preflight

## Slice

Node v1137 contributes request manifest package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
