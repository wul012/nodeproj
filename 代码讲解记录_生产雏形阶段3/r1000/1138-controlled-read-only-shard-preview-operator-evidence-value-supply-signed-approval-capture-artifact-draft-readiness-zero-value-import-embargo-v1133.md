# Code walkthrough 1138: Node v1133 zero value import embargo lane

This walkthrough explains how Node v1133 participates in the signed approval artifact draft readiness package. The implementation is intentionally split so the long governance chain stays maintainable instead of turning the profile service into one giant file.
...
- v1133 lane: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_READINESS_ZERO_VALUE_IMPORT_EMBARGO`.
- Source field checked by builder: `zeroValueImportLock`.
- Blocker emitted by control catalog: `REJECT_DRAFT_READINESS_VALUE_IMPORT_NONZERO`.
