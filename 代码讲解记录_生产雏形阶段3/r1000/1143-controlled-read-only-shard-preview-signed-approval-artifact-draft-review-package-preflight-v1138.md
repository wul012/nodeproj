# Code walkthrough 1143 - Node v1138 signed approval artifact draft review package preflight

## Slice

Node v1138 contributes artifact preflight digest package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
