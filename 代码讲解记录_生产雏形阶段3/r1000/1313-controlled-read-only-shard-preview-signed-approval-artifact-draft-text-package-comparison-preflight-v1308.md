# 1313. Node v1308 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1308 focuses on the execution lock slice: keeps production execution locked and documents that this preflight is offline only.
