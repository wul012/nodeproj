# Code walkthrough 1132: Node v1127 redacted value digest pin lane

This walkthrough explains how Node v1127 participates in the signed approval artifact draft readiness package. The implementation is intentionally split so the long governance chain stays maintainable instead of turning the profile service into one giant file.
...
- v1127 lane: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_READINESS_REDACTED_VALUE_DIGEST_PIN`.
- Source field checked by builder: `redactedValueDigest`.
- Blocker emitted by control catalog: `REJECT_DRAFT_READINESS_REDACTED_VALUE_DIGEST_UNPINNED`.
