# 1309. Node v1304 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1304 focuses on the policy slice: records reviewer-separation policy as a package acceptance requirement instead of an approval grant.
