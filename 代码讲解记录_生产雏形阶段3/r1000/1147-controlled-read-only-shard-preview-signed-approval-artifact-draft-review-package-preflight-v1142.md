# Code walkthrough 1147 - Node v1142 signed approval artifact draft review package preflight

## Slice

Node v1142 contributes operator role package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
