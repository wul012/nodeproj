# 1243. Node v1238 signed approval artifact draft text package review preflight walkthrough
...
Node v1238 focuses on requester identity: keeps requester identity review separate from approval capture so no grant is inferred from metadata.
