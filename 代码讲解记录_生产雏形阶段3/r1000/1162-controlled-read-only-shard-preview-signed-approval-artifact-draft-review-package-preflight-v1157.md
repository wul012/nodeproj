# Code walkthrough 1162 - Node v1157 signed approval artifact draft review package preflight

## Slice

Node v1157 contributes approval grant embargo package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
