# Code walkthrough: Node v1092 signed approval capture artifact draft preflight operator role draft field
...
Node v1092 contributes operator role draft field. The code keeps readyForSignedApprovalArtifactDraft=false, readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Field: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_PREFLIGHT_OPERATOR_ROLE`.
- Guard: `ARTIFACT_DRAFT_PREFLIGHT_OPERATOR_ROLE_GUARD`.
- Source artifact fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_OPERATOR_ROLE`.
- Required artifact fragment: `operatorRole`.
- Blocker: `ARTIFACT_DRAFT_PREFLIGHT_OPERATOR_ROLE_MISSING`.
