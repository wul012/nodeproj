# 1271. Node v1266 signed approval artifact draft text package submission preflight walkthrough
...
Node v1266 focuses on the digest slice: adds the first digest comparison pin so manual package material can later be compared without changing sibling state.
