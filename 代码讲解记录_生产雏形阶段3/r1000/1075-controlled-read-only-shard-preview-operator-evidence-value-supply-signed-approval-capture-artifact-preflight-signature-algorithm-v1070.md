# Code walkthrough: Node v1070 signed approval capture artifact preflight signature algorithm artifact fragment
...
Node v1070 contributes signature algorithm artifact fragment. The code keeps readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_SIGNATURE_ALGORITHM`.
- Seal: `ARTIFACT_PREFLIGHT_SIGNATURE_ALGORITHM_SEAL`.
- Source capture input: `SIGNED_APPROVAL_CAPTURE_PREFLIGHT_SIGNATURE_ALGORITHM`.
- Required capture field: `signatureAlgorithmPolicy`.
- Blocker: `ARTIFACT_PREFLIGHT_SIGNATURE_ALGORITHM_MISSING`.
