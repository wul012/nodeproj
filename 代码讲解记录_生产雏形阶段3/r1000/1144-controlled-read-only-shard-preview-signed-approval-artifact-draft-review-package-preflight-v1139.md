# Code walkthrough 1144 - Node v1139 signed approval artifact draft review package preflight

## Slice

Node v1139 contributes template digest package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
