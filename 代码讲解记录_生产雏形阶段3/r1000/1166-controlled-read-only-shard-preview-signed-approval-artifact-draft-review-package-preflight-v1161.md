# Code walkthrough 1166 - Node v1161 signed approval artifact draft review package preflight

## Slice

Node v1161 contributes review package closeout slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
