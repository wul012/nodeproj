# Code walkthrough 1165 - Node v1160 signed approval artifact draft review package preflight

## Slice

Node v1160 contributes sibling non-mutation package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
