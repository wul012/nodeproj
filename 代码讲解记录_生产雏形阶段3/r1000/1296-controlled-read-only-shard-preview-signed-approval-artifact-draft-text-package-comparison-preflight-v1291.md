# 1296. Node v1291 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1291 focuses on the digest slice: adds the first digest recheck lane so manual package material can later be compared without changing sibling state.
