# Code walkthrough 1157 - Node v1152 signed approval artifact draft review package preflight

## Slice

Node v1152 contributes redacted value digest package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
