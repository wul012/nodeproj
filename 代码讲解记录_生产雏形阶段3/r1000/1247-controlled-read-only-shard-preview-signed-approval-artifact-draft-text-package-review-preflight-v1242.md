# 1247. Node v1242 signed approval artifact draft text package review preflight walkthrough
...
Node v1242 focuses on review packet digest: requires review packet digest recheck before any package can be accepted.
