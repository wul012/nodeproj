# Code walkthrough: Node v1110 signed approval capture artifact draft preflight sibling non-mutation draft lock
...
Node v1110 contributes sibling non-mutation draft lock. The code keeps readyForSignedApprovalArtifactDraft=false, readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Field: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_PREFLIGHT_SIBLING_NON_MUTATION_LOCK`.
- Guard: `ARTIFACT_DRAFT_PREFLIGHT_SIBLING_NON_MUTATION_GUARD`.
- Source artifact fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_SIBLING_NON_MUTATION_LOCK`.
- Required artifact fragment: `siblingNonMutationLock`.
- Blocker: `ARTIFACT_DRAFT_PREFLIGHT_SIBLING_NON_MUTATION_LOCK_MISSING`.
