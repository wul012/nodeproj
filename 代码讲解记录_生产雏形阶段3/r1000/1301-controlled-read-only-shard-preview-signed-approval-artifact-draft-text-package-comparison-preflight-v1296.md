# 1301. Node v1296 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1296 focuses on the signature slice: separates signer identity comparison from package acceptance and keeps approvalCaptured=false.
