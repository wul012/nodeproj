# Code walkthrough: Node v1091 signed approval capture artifact draft preflight operator identity draft field
...
Node v1091 contributes operator identity draft field. The code keeps readyForSignedApprovalArtifactDraft=false, readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Field: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_PREFLIGHT_OPERATOR_IDENTITY`.
- Guard: `ARTIFACT_DRAFT_PREFLIGHT_OPERATOR_IDENTITY_GUARD`.
- Source artifact fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_OPERATOR_IDENTITY`.
- Required artifact fragment: `operatorIdentity`.
- Blocker: `ARTIFACT_DRAFT_PREFLIGHT_OPERATOR_IDENTITY_MISSING`.
