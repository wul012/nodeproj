# Code walkthrough: Node v1108 signed approval capture artifact draft preflight zero value import draft lock
...
Node v1108 contributes zero value import draft lock. The code keeps readyForSignedApprovalArtifactDraft=false, readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Field: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_PREFLIGHT_ZERO_VALUE_IMPORT_LOCK`.
- Guard: `ARTIFACT_DRAFT_PREFLIGHT_ZERO_VALUE_IMPORT_GUARD`.
- Source artifact fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_ZERO_VALUE_IMPORT_LOCK`.
- Required artifact fragment: `zeroValueImportLock`.
- Blocker: `ARTIFACT_DRAFT_PREFLIGHT_ZERO_VALUE_IMPORT_LOCK_MISSING`.
