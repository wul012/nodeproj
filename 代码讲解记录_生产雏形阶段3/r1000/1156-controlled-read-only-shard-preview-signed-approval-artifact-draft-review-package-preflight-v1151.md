# Code walkthrough 1156 - Node v1151 signed approval artifact draft review package preflight

## Slice

Node v1151 contributes source evidence snippet package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
