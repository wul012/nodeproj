# Code walkthrough 1164 - Node v1159 signed approval artifact draft review package preflight

## Slice

Node v1159 contributes write route embargo package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
