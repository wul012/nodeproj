# Code walkthrough: Node v1078 signed approval capture artifact preflight value shape fragment
...
Node v1078 contributes value shape fragment. The code keeps readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_VALUE_SHAPE`.
- Seal: `ARTIFACT_PREFLIGHT_VALUE_SHAPE_SEAL`.
- Source capture input: `SIGNED_APPROVAL_CAPTURE_PREFLIGHT_VALUE_SHAPE`.
- Required capture field: `valueShape`.
- Blocker: `ARTIFACT_PREFLIGHT_VALUE_SHAPE_MISSING`.
