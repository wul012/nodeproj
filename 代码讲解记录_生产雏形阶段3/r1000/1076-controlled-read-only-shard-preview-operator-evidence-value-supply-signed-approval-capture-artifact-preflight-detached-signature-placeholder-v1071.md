# Code walkthrough: Node v1071 signed approval capture artifact preflight detached signature placeholder
...
Node v1071 contributes detached signature placeholder. The code keeps readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_DETACHED_SIGNATURE_PLACEHOLDER`.
- Seal: `ARTIFACT_PREFLIGHT_DETACHED_SIGNATURE_PLACEHOLDER_SEAL`.
- Source capture input: `SIGNED_APPROVAL_CAPTURE_PREFLIGHT_APPROVAL_STATEMENT`.
- Required capture field: `approvalStatement`.
- Blocker: `ARTIFACT_PREFLIGHT_DETACHED_SIGNATURE_PLACEHOLDER_MISSING`.
