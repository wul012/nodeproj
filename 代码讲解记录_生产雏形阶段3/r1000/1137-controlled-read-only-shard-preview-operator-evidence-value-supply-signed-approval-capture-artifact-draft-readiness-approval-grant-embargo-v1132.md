# Code walkthrough 1137: Node v1132 approval grant embargo lane

This walkthrough explains how Node v1132 participates in the signed approval artifact draft readiness package. The implementation is intentionally split so the long governance chain stays maintainable instead of turning the profile service into one giant file.
...
- v1132 lane: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_READINESS_APPROVAL_GRANT_EMBARGO`.
- Source field checked by builder: `noApprovalGrantEmittedLock`.
- Blocker emitted by control catalog: `REJECT_DRAFT_READINESS_APPROVAL_GRANT_EMITTED`.
