# 1251. Node v1246 signed approval artifact draft text package review preflight walkthrough
...
Node v1246 focuses on signature algorithm metadata: keeps algorithm metadata reviewable without allowing private key or signature material into Node.
