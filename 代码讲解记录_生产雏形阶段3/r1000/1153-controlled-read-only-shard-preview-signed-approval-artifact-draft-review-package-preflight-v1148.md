# Code walkthrough 1153 - Node v1148 signed approval artifact draft review package preflight

## Slice

Node v1148 contributes approval statement digest package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
