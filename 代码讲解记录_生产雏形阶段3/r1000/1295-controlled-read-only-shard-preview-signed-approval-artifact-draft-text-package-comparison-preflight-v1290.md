# 1295. Node v1290 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1290 focuses on the identity slice: records the approval-intent comparison lane and blocks acceptance until a later submitted package comparison exists.
