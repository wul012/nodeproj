# 1267. Node v1262 signed approval artifact draft text package submission preflight walkthrough
...
Node v1262 focuses on the identity slice: opens the manual submission surface with the request manifest slot and a comparison control that rejects missing package material before any signed draft text can be accepted.
