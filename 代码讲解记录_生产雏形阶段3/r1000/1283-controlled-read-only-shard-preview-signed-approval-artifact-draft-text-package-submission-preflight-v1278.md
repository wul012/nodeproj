# 1283. Node v1278 signed approval artifact draft text package submission preflight walkthrough
...
Node v1278 focuses on the policy slice: turns policy readiness into a submission slot and blocks acceptance until a later package comparison exists.
