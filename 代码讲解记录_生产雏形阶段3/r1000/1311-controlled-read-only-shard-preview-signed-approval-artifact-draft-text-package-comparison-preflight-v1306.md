# 1311. Node v1306 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1306 focuses on the execution lock slice: adds the runtime-payload blocker to the acceptance control surface.
