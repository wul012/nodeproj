# Code walkthrough 1149 - Node v1144 signed approval artifact draft review package preflight

## Slice

Node v1144 contributes capture channel policy package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
