# Code walkthrough: Node v1097 signed approval capture artifact draft preflight signature redaction draft field
...
Node v1097 contributes signature redaction draft field. The code keeps readyForSignedApprovalArtifactDraft=false, readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Field: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_PREFLIGHT_SIGNATURE_REDACTION`.
- Guard: `ARTIFACT_DRAFT_PREFLIGHT_SIGNATURE_REDACTION_GUARD`.
- Source artifact fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_SIGNATURE_REDACTION`.
- Required artifact fragment: `signatureMaterialRedactionPolicy`.
- Blocker: `ARTIFACT_DRAFT_PREFLIGHT_SIGNATURE_REDACTION_MISSING`.
