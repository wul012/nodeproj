# 1299. Node v1294 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1294 focuses on the digest slice: closes the digest family with a read-only source digest lane and acceptance control.
