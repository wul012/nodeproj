# Code walkthrough: Node v1074 signed approval capture artifact preflight source evidence version fragment
...
Node v1074 contributes source evidence version fragment. The code keeps readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_SOURCE_VERSION`.
- Seal: `ARTIFACT_PREFLIGHT_SOURCE_VERSION_SEAL`.
- Source capture input: `SIGNED_APPROVAL_CAPTURE_PREFLIGHT_SOURCE_VERSION`.
- Required capture field: `sourceEvidenceVersion`.
- Blocker: `ARTIFACT_PREFLIGHT_SOURCE_VERSION_MISSING`.
