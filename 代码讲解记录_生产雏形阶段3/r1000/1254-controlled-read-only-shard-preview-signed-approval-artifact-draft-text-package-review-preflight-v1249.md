# 1254. Node v1249 signed approval artifact draft text package review preflight walkthrough
...
Node v1249 focuses on mini-kv source evidence handle: binds mini-kv evidence handle review to frozen/historical evidence without starting mini-kv.
