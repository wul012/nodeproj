# 1256. Node v1251 signed approval artifact draft text package review preflight walkthrough
...
Node v1251 focuses on operator value handle: keeps operator value references as handles only and blocks credential value reads.
