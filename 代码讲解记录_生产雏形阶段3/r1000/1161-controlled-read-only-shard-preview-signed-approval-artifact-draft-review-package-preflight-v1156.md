# Code walkthrough 1161 - Node v1156 signed approval artifact draft review package preflight

## Slice

Node v1156 contributes raw secret embargo package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
