# Code walkthrough 1148 - Node v1143 signed approval artifact draft review package preflight

## Slice

Node v1143 contributes capture window package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
