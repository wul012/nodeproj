# 1302. Node v1297 signed approval artifact draft text package comparison preflight walkthrough
...
Node v1297 focuses on the signature slice: records the signature timestamp requirement as a pre-acceptance control instead of an execution permission.
