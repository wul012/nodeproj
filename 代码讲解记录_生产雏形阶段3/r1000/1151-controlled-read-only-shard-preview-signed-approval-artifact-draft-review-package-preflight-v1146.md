# Code walkthrough 1151 - Node v1146 signed approval artifact draft review package preflight

## Slice

Node v1146 contributes detached signature placeholder package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
