# 1279. Node v1274 signed approval artifact draft text package submission preflight walkthrough
...
Node v1274 focuses on the source slice: maps mini-kv source evidence to a submission slot while documenting that no mini-kv service start is required.
