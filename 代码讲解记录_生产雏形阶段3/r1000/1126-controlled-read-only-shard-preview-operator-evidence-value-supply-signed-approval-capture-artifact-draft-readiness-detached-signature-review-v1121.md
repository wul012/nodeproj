# Code walkthrough 1126: Node v1121 detached signature placeholder review lane

This walkthrough explains how Node v1121 participates in the signed approval artifact draft readiness package. The implementation is intentionally split so the long governance chain stays maintainable instead of turning the profile service into one giant file.
...
- v1121 lane: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_READINESS_DETACHED_SIGNATURE_REVIEW`.
- Source field checked by builder: `detachedSignaturePlaceholder`.
- Blocker emitted by control catalog: `REJECT_DRAFT_READINESS_DETACHED_SIGNATURE_PLACEHOLDER_UNREVIEWED`.
