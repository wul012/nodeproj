# v1487 code walkthrough

v1487 authoring readiness migration: keeps `signedApprovalCaptureArtifactDraftAuthoringReadinessVersion` fixed at `Node v1186` and preserves runtime payload import as false.
