# Code walkthrough: Node v1100 signed approval capture artifact draft preflight source evidence file draft field
...
Node v1100 contributes source evidence file draft field. The code keeps readyForSignedApprovalArtifactDraft=false, readyForSignedApprovalCapture=false, readyForOperatorValueSupply=false, readyForEvidenceImport=false, readyForRuntimePayload=false, and executionAllowed=false.

## Version-Specific Mapping

- Field: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_PREFLIGHT_SOURCE_FILE`.
- Guard: `ARTIFACT_DRAFT_PREFLIGHT_SOURCE_FILE_GUARD`.
- Source artifact fragment: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_SOURCE_FILE`.
- Required artifact fragment: `sourceEvidenceFileId`.
- Blocker: `ARTIFACT_DRAFT_PREFLIGHT_SOURCE_FILE_MISSING`.
