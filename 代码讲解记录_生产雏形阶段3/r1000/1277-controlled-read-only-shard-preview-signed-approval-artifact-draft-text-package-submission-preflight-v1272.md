# 1277. Node v1272 signed approval artifact draft text package submission preflight walkthrough
...
Node v1272 focuses on the signature slice: records the signature timestamp requirement as a pre-submission control instead of an execution permission.
