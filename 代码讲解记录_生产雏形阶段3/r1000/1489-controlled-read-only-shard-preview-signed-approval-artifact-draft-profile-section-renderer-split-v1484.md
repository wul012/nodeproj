# v1484 code walkthrough

v1484 draft preflight migration: keeps `signedApprovalCaptureArtifactDraftPreflightVersion` fixed at `Node v1111` and preserves `draftArtifactCreated: false`.
