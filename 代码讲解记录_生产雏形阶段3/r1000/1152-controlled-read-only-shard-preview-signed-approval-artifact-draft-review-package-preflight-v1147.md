# Code walkthrough 1152 - Node v1147 signed approval artifact draft review package preflight

## Slice

Node v1147 contributes signature redaction package slot. The declarative slot lives in the review package preflight slot catalog, and the matching guard lives in the guard catalog.
