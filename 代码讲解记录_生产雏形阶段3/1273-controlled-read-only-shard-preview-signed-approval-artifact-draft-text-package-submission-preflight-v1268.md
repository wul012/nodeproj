# 1273. Node v1268 signed approval artifact draft text package submission preflight walkthrough
...
Node v1268 focuses on the digest slice: keeps the v1236 intake digest reachable from the submission preflight and marks it as a digest-comparison pin.
