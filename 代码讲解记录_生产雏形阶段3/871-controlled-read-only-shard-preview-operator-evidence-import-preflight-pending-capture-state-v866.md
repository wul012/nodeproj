# Node v866 code walkthrough: operator evidence import preflight pending capture state

v866 contributes `IMPORT_PREFLIGHT_PENDING_CAPTURE_STATE` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_PENDING_CAPTURE_STATE` from the v861 worksheet and keeps already-captured runtime evidence blocked at import preflight.
