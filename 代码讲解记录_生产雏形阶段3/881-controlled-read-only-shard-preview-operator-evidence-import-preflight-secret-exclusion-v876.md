# Node v876 code walkthrough: operator evidence import preflight secret exclusion

v876 contributes `IMPORT_PREFLIGHT_SECRET_EXCLUSION` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_SECRET_EXCLUSION` from the v861 worksheet and keeps secret exclusion explicit in every future import slot.
