# Code walkthrough 1136: Node v1131 raw secret embargo lane

This walkthrough explains how Node v1131 participates in the signed approval artifact draft readiness package. The implementation is intentionally split so the long governance chain stays maintainable instead of turning the profile service into one giant file.
...
- v1131 lane: `SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_READINESS_RAW_SECRET_EMBARGO`.
- Source field checked by builder: `noRawSecretLock`.
- Blocker emitted by control catalog: `REJECT_DRAFT_READINESS_RAW_SECRET_PRESENT`.
