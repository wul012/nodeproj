# Node v875 code walkthrough: operator evidence import preflight failure class coverage

v875 contributes `IMPORT_PREFLIGHT_FAILURE_CLASS_COVERAGE` to the operator evidence import preflight. It maps back to `ENTRY_WORKSHEET_FAILURE_CLASS_COVERAGE` from the v861 worksheet and preserves failure class coverage without turning triage into execution.
