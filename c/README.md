...
- `c/274/`：credential resolver disabled candidate upstream echo verification，记录 Node v273、Java v113、mini-kv v120 的 candidate counts、boundary scopes、interface shape、fake wiring 和 no-side-effect 边界三方对齐，并收口 v272 衍生计划。
