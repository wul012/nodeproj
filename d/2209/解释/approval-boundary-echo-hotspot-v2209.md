...
强制历史 fallback、固定时间并在渲染前递归规范化路径后，v2209 的完整 JSON 固定为 38,431 字节；Markdown 固定为 37,992 字节。v2210 进一步证明历史文本的 digest 已基于规范化内容、`sizeBytes` 却仍取原始文件大小，并把二者统一到同一份规范化 UTF-8 字节；最终跨平台 SHA-256 分别是 JSON `fe1823311fcd14e730e875dc546548df777c041ef76c9e2c978a2ac5c96bfade`、Markdown `6f29d65826ad60d4f960a88835b7d8b202f2b1979695551295b8690e17dca1c8`。v2207、v2208 预言机不受影响，业务 renderer 与 fixture 均未修改。
