...
- Generated at: 2026-05-25T13:12:38.168Z
- Profile version: managed-audit-manual-sandbox-connection-credential-resolver-read-only-cross-project-readiness-runner.v1
- Runner state: read-only-cross-project-readiness-ready
- Active Node version: Node v327
...
- Ready for read-only cross-project readiness report: true
...
- Prohibited field count: 14
- No-go boundary count: 11
- Implementation still blocked: true

## Java v150 Evidence

- Evidence path: D:/javaproj/advanced-order-platform/d/150/解释/说明.md
- Resolved path: D:\nodeproj\orderops-node\fixtures\historical\sibling-workspaces\javaproj\advanced-order-platform\d\150\解释\说明.md
- Evidence present: true
- Digest: 03115de9ccedc6c42bfb3c529e951a163a0685473aebf87592332017aa2897b8
- Read-only echo documented: true
- SQL / rollback / ledger / network denied: true
- Runtime / provider / client denied: true
- Automatic upstream start denied: true
- Ready for Node consumption: true

## mini-kv v142 Receipt

- Receipt path: D:/C/mini-kv/fixtures/release/credential-resolver-abort-rollback-semantics-contract-non-participation-receipt.json
- Resolved path: D:\nodeproj\orderops-node\fixtures\historical\sibling-workspaces\mini-kv\fixtures\release\credential-resolver-abort-rollback-semantics-contract-non-participation-receipt.json
- Evidence present: true
- Digest: 4b7cc7a292cd8ac0be6616294defb71bb9c4479d0328f9b812f9ceef78267bec
- Receipt version: mini-kv-credential-resolver-abort-rollback-semantics-contract-non-participation-receipt.v1
- Release version: v142
- Read only: true
- Execution allowed: false
- Restore execution allowed: false
- mini-kv write command allowed: false
- LOAD/RESTORE/COMPACT executed: false
- SETNXEX allowed: false
- Abort/rollback authority: false
- Consumes Node v326: true
- Ready for Node v327: true
- Ready for Node consumption: true
...
- javaV150NoRuntimeProviderClientDocumented: true
- javaV150NoAutomaticUpstreamStartDocumented: true
...
- [warning] READINESS_RUNNER_DOES_NOT_OPEN_RUNTIME (next-step): v327 proves read-only cross-project consumption only; it is not approval for runtime shell work.
- [warning] JAVA_EVIDENCE_IS_MARKDOWN_UNTIL_STABLE_EXPORT_EXISTS (java-v150): Java v150 is currently consumed from local archive Markdown; future Java work may stabilize JSON export.

## Recommendations

- [recommendation] LET_NODE_V328_CONSUME_THIS_REPORT (next-step): Node v328 should consume this v327 report for final prerequisite closure review.
- [recommendation] HARDEN_INPUT_EXPORTS_AFTER_CLOSURE (next-step): After v328, harden stable input exports and historical fallback before discussing implementation gates.
